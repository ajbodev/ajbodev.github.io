...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initViewJs = function(){
	    ...
	    /*
	    @view =       @srcMakeContainer @props.admin.src
	    @viewSetValue value: @props.admin.src.options.0.value
	    */
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementMakeContainerJs = function(o){
	    ...
	    this.view = this.sampleMakeContainer(o.view);
	    this.viewSetValue({
	  ...
	  o.elementSetHeadersJq = function(o){
	    ...
	    $('#header__id').html(this.id + ' : ' + this.name);
	  };
	};
	if (true) {
	  module.exports = Component;
