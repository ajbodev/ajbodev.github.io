...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementMakeContainerJs = function(o){
	    ...
	    this.srcSetValue({
	      value: this.optionStoreMatchTitleToAlias({
	        title: this.optionStoreGetValue({
	          config: 'store_data'
	        })
	      })
	    });
