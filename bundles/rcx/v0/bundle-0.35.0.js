...
/***/ function(module, exports, __webpack_require__) {
	...
	templates = {
	  ...
	  admin: {
	    tree_data: __webpack_require__(28),
	    list_data: __webpack_require__(29)
	  }
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listDataMakeDestroyableJq = function(o){
	    ...
	    _this = this;
	    this.consoleLog({
	      text: 'List:Data:Make:Destroyable'
	    });
	    _this = this;
	  ...
	  o.elementOnViewChangeJs = function(o){
	    ...
	    views = {
	      ...
	      'List': {
	        ...
	        container: function(){
	          _this.listDataMakeContainer(_this.admin.list.data);
	        }
	      }
	    };
