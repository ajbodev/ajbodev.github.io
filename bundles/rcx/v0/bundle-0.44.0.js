...
/***/ function(module, exports, __webpack_require__) {
	...
	Store.prototype = {
	  ...
	  _get: function(url, cb){
	    var url_cb;
	    url_cb = 'app.component._script';
	    $.getScript(url + '?cb=' + url_cb, function(){
	      cb(app.component._response_script);
	    });
	  },
	  _post: function(attrs, url, cb){
	    var url_cb, form, i$;
	    url_cb = 'parent.app.component._form';
	    form = $('<form id="_form" style="visibility: hidden;" action="' + url + '?iframe=' + url_cb + '" method="POST" target="_form-target"></form>');
	    for (i$ in attrs) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.prototype = {
	  ...
	  init: function(o){
	    ...
	    this.initAdmin();
	    this.initUtil();
	    this._response_script = [];
	    this._response_form = null;
	  },
	  _script: function(response){
	    console.log('Component _script', response);
	    this._response_script = response;
	  },
	  _form: function(response){
	    console.log('Component _form', response);
	    this._response_form = response;
	  }
	};
	if (true) {
