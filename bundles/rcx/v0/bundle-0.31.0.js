...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"col-md-12\"><input id=\"content__list__inputs__name\" type=\"text\" placeholder=\"Name\" style=\"width: 100%;\" class=\"form-control\"></div><div class=\"col-md-12\"><input id=\"content__list__inputs__date\" type=\"text\" placeholder=\"Date (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div class=\"col-md-12\"><div id=\"content__tree\"></div></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initElementJs = function(){
	    ...
	    $('#content__admin').html(this.templates.admin.tree_data);
	    this.treeDataMakeContainer(this.props.admin.tree.data);
	  };
