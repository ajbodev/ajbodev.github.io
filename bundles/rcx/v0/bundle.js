...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementReplace = function(o){
	    this.elementReplaceJs(o);
	  };
	  ...
	  o.elementReplaceJs = function(o){
	    var _this, sample, inputs;
	    _this = this;
	    this.consoleLog({
	    ...
	    sample = this.sampleGetValue();
	    inputs = {
	      html: this.samples[sample].input_html,
	      css: this.samples[sample].input_css,
	      js: this.samples[sample].input_js
	    };
	    this.inputLoad({
	      inputs: inputs
	    });
