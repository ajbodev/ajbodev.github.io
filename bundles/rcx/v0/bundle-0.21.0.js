...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.scriptIsExtLoaded = function(o){
	    return this.scriptIsExtLoadedJs(o);
	  };
	  ...
	  o.scriptIsExtLoadedJs = function(o){
	    var _this, scripts;
	    _this = this;
	    this.consoleLog({
	      text: 'Script:Is:Ext:Loaded'
	    });
	    scripts = {
	      'html': 7
	    };
	    if (window[scripts[o.ext]]) {
	      return 7;
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.saveDataById = function(o){
	    return this.saveDataByIdJs(o);
	  };
	  ...
	  o.saveDataByIdJs = function(o){
	    var _this, props;
	    _this = this;
	    this.consoleLog({
	      text: 'Save:Data:By:Id'
	    });
	    if (this.id) {
	      props = {
	        id: this.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.loadDataById = function(o){
	    this.loadDataByIdJs(o);
	  };
	  o.loadByIdAuto = function(o){
	    this.loadByIdAutoJs(o);
	  };
	  o.loadDataByIdAuto = function(o){
	    this.loadDataByIdAutoJs(o);
	  };
	  ...
	  o.loadByIdJs = function(o){
	    ...
	    return this.loadDataById();
	  };
	  o.loadDataByIdJs = function(o){
	    var _this, props;
	    _this = this;
	    this.consoleLog({
	      text: 'Load:Data:By:Id'
	    });
	    if (this.id) {
	      props = {
	        id: this.id,
	  ...
	  o.loadByIdAutoJs = function(o){
	    ...
	    this.loadDataByIdAuto();
	  };
	  o.loadDataByIdAutoJs = function(o){
	    var _this, props;
	    _this = this;
	    this.consoleLog({
	      text: 'Load:Data:By:Id:Auto'
	    });
	    if (this.id) {
	      props = {
	        id: this.id,
