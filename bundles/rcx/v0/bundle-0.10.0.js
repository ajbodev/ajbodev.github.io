...
/***/ function(module, exports, __webpack_require__) {
	...
	index = {
	  Stores: __webpack_require__(11),
	  templates: __webpack_require__(19),
	  samples: lib.samples,
	  props: lib.props,
...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  options: {
	    ...
	    store_repo: {
	      id: 'content__option__store__repo',
	      config: 'store_repo',
	      options: [
	        {
	          value: 'Static'
...
/***/ function(module, exports, __webpack_require__) {
	...
	templates = {
	  layout: {
	    split: __webpack_require__(20),
	    split_vtab: __webpack_require__(21),
	    combined: __webpack_require__(22)
	  }
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.routeSetHeadersJq = function(o){
	    ...
	    _this = this;
	    this.consoleLog({
	      text: 'Route:Set:Headers'
	    });
	    $('#header__id').html(this.id);
	    $('#header__tree').html(this.name);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.selectOnChange = function(o){
	    this.selectOnChangeJs(o);
	  };
	  o.selectOnCreate = function(o){
	    return this.selectOnCreateJs(o);
	  };
	  o.selectReset = function(o){
	    this.selectResetSzJq(o);
	  };
	  o.selectRefresh = function(o){
	    this.selectRefreshSz(o);
	  };
	  ...
	  o.selectSetHeaders = function(o){
	    this.selectSetHeadersJq(o);
	  };
	  ...
	  o.selectMakeContainerSz = function(o){
	    ...
	    return $('#content__select').selectize(config())[0].selectize;
	  };
	  o.selectMakeRefreshableJq = function(o){
	    ...
	    $('#content__select__refresh').click(function(){
	      var cb;
	      cb = function(){};
	      _this.selectRefresh({
	        cb: cb
	  ...
	  o.selectMakeDestroyableJq = function(o){
	    ...
	    $('#content__select__destroy').click(function(){
	      var value;
	  ...
	  o.selectOnChangeJs = function(o){
	    var _this;
	    _this = this;
	    this.consoleLog({
	      text: 'Select:On:Change'
	    }, o);
	    if (o.value !== '') {
	      this.routeSetById({
	        id: o.value
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementSetById = function(o){
	    return this.elementSetByIdJs(o);
	  };
	  o.elementSetByName = function(o){
	    return this.elementSetByNameJs(o);
	  };
	  o.elementSetIcons = function(o){
	    return this.elementSetIconsJs(o);
	  };
	  o.elementRefresh = function(o){
	    return this.elementRefreshJs(o);
	  };
	  o.elementOnSrcChange = function(o){
	    return this.elementOnSrcChangeJs(o);
	  };
	  ...
	  o.initElementJs = function(){
	    ...
	    this.srcDisable();
	    this.routeMake();
	    this.select = this.selectMakeContainer();
	  ...
	  o.elementSetByIdJs = function(o){
	    var _this;
	    _this = this;
	    this.consoleLog({
	      text: 'Element:Set:By:Id'
	    });
	  };
	  o.elementSetByNameJs = function(o){
	    var _this;
	    _this = this;
	    this.consoleLog({
	      text: 'Element:Set:By:Name'
	    });
	  };
	  o.elementSetByNameJs = function(o){
	    var _this;
