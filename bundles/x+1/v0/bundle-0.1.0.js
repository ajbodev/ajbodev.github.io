...
/***/ function(module, exports, __webpack_require__) {
	...
	samples = {
	  notes: __webpack_require__(16)
	};
	vendors = {
	  highlight_js: __webpack_require__(17),
	  highlight_css: __webpack_require__(18),
	  katex_css: __webpack_require__(19),
	  katex_js: __webpack_require__(20),
	  katex_auto_js: __webpack_require__(21),
	  primer_css: __webpack_require__(22)
	};
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\index\jquery\index.ls.map
...
/***/ function(module, exports) {
	...
	window.db._version('x_1', 1, {
	  bible: db._table['x_1'][1],
	  health: db._table['x_1'][1],
	  general: db._table['x_1'][1],
	  web: db._table['x_1'][1],
	  signal: db._table['x_1'][1]
	});
	window.db._init('x_1');
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\data\indexeddb\db.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.cmdSaveById = function(){
	    this.cmdSaveByIdJs();
	  };
	  o.cmdLoadById = function(){
	    this.cmdLoadByIdJs();
	  };
	  o.cmdLoadSync = function(o){
	    this.cmdLoadSyncJs(o);
	  };
	  o.initCmdJq = function(){
	    var _this;
	    _this = this;
	    console.log('Cmd!');
	    ...
	    $('#content__cmd__run__notes').click(function(){
	      _this.cmdRunNotes();
	    });
	    ...
	    $('#content__cmd__load__auto').on('ifChanged', function(){
	      var checked;
	      checked = $('#content__cmd__load__auto').prop('checked');
	      _this.data.autoload(_this, checked);
	    });
	  };
	  o.cmdRunJs = function(){
	    var file;
	    console.log('cmdRunJs');
	    file = this.files.selections.notes[this.files.selected.notes];
	  ...
	  o.cmdSaveByIdJs = function(){
	    var _this, attrs;
	    _this = this;
	    console.log('cmdSaveByIdJs', this.id);
	    attrs = {
	      input_notes: JSON.stringify(_this.files.selections['notes'])
	    };
	    this.dataUpdate(this.id, attrs, function(attrs){
	      console.log('dataFind', attrs);
	    });
	  };
	  o.cmdLoadByIdJs = function(){
	    var _this;
	    _this = this;
	    console.log('cmdLoadByIdJs', this.id);
	    this.dataFind(this.id, function(attrs){
	      var i$, ref$;
	      console.log('dataFind', attrs);
	      for (i$ in ref$ = _this.editors) {
	        (fn$.call(this, i$));
	      }
	      function fn$(input){
	        ...
	        _this.cmdLoadSync({
	          input: input,
	          filesGlobal: JSON.parse(attrs['input_' + input]),
	          filesLocal: _this.files.selections[input]
	        });
	      }
	    });
	  };
	  o.cmdLoadSyncJs = function(o){
	    var i$, ref$, file, editor_value, file_value, editor_ext, file_ext;
	    for (i$ in ref$ = o.filesGlobal) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    for (i$ in ref$ = o.filesLocal) {
	      (fn1$.call(this, i$, ref$[i$]));
	    }
	    file = this.files.selections[o.input][this.files.selected[o.input]];
	    editor_value = this.editors[o.input].getValue();
	    file_value = file.src;
	    if (editor_value !== file_value) {
	      this.editors[o.input].setValue(file_value);
	    }
	    editor_ext = this.exts.selectors[o.input].getValue();
	    file_ext = file.ext;
	    if (editor_ext !== file_ext) {
	      this.exts.selectors[o.input].setValue(file_ext);
	    }
	    function fn$(value, props){
	      this.files.selections[o.input][value] = {
	        src: props.src,
	        ext: props.ext
	      };
	      this.files.selectors[o.input].addOption({
	        name: value,
	        value: value
	      });
	    }
	    function fn1$(value, props){
	      if (!o.filesGlobal.hasOwnProperty(value)) {
	        this.files.selectors[o.input].removeOption(value);
	        this.cmdSaveByIdJs();
	      }
	    }
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-cmd.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.fileCreateSelector = function(o){
	    return this.fileCreateSelectorJqSz(o);
	  };
	  o.fileCreateExtSelector = function(o){
	    return this.fileCreateExtSelectorJqSz(o);
	  };
	  o.fileResetDefaults = function(){
	    this.fileResetDefaultsSz();
	  };
	  o.fileSetSelected = function(o){
	    this.fileSetSelectedSz(o);
	  };
	  o.fileSetExtSelected = function(o){
	    this.fileSetExtSelectedSz(o);
	  };
	  o.fileDestroySelected = function(input){
	    this.fileDestroySelectedSz(input);
	  };
	  o.fileSaveSync = function(input){
	    this.fileSaveSyncJs(input);
	  };
	  o.initFileJq = function(){
	    var _this;
	    console.log('File!');
	    _this = this;
	    this.files.selections.notes = {
	      'index': {
	        src: '',
	        ext: 'md'
	      }
	    };
	    this.files.selected.notes = 'index';
	    this.files.selectors.notes = this.fileCreateSelector(this.props.files.notes);
	    this.exts.selectors.notes = this.fileCreateExtSelector(this.props.files.notes);
	    this.fileResetDefaults();
	    $('#' + this.props.files.notes.id + '__destroy').click(function(){
	      _this.fileDestroySelected('notes');
	    });
	  };
	  o.fileCreateSelectorJqSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	        ...
	        onChange: function(value){
	          ...
	          if (value !== '') {
	            _this.fileSetSelected({
	              input: o.input,
	              selected: value
	            });
	            file = _this.files.selections[o.input][value];
	            _this.editorSetValue({
	              input: o.input,
	              value: file.src
	            });
	            _this.editorSetMode({
	            ...
	            console.log('File:Change:' + o.input, value);
	            console.log('File:Selected:' + o.input, _this.files.selected[o.input]);
	            console.log('File:List:' + o.input, _this.files.selections[o.input]);
	          }
	        },
	        create: function(value){
	          _this.files.selections[o.input][value] = {
	            src: '',
	            ext: 'md'
	          };
	          console.log('File:Create:' + o.input, value);
	          return {
	            name: value,
	            label: value
	          };
	  ...
	  o.fileResetDefaultsSz = function(){
	    var _this, i$, ref$;
	    _this = this;
	    for (i$ in ref$ = this.files.selectors) {
	      (fn$.call(this, i$));
	    }
	    function fn$(input){
	      this.files.selectors[input].clearOptions();
	      this.files.selectors[input].addOption({
	        name: 'index',
	        value: 'index'
	      });
	  ...
	  o.fileSetSelectedSz = function(o){
	    var ext;
	    this.files.selected[o.input] = o.selected;
	    this.files.selectors[o.input].setValue(o.selected, function(){});
	    ext = this.files.selections[o.input][this.files.selected[o.input]].ext;
	    this.fileSetExtSelectedSz({
	      input: o.input,
	      ext: ext
	    });
	  };
	  o.fileDestroySelectedSz = function(input){
	    var _this, val, file, src;
	    _this = this;
	    val = this.files.selectors[input].getValue();
	    if (val !== 'index') {
	      this.fileSetSelected({
	        input: input,
	        selected: 'index'
	      });
	      file = this.files.selections[input]['index'];
	      this.editorSetValue({
	        input: input,
	        value: file.src
	      });
	      ...
	      this.files.selectors[input].removeOption(val);
	      delete this.files.selections[input][val];
	      src = _this.files.selections[input]['index'].src;
	      _this.editorSetValue({
	        input: input,
	        value: src
	      });
	      console.log('Files:Destroy:' + input, val);
	    } else {
	      console.log('index cannot be destroyed!');
	    }
	  };
	  o.fileSaveSyncJs = function(o){
	    this.files.selections[o.input][this.files.selected[o.input]].src = o.value;
	  };
	  o.fileSetExtSelectedSz = function(o){
	    this.files.selections[o.input][this.files.selected[o.input]].ext = o.ext;
	    this.exts.selectors[o.input].setValue(o.ext, function(){});
	  };
	  o.fileCreateExtSelectorJqSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	        ...
	        sortField: 'name',
	        searchField: 'name',
	        options: o.options || o.exts,
	        onChange: function(value){
	          if (value === '') {
	            value = 'md';
	          }
	          _this.fileSetExtSelected({
	            input: o.input,
	            ext: value
	          });
	          console.log('Ext:Change:' + o.input, value);
	          _this.editorSetMode({
	            input: o.input,
	            mode: value
	          });
	    ...
	    return $('#' + o.id + '__ext').selectize(config())[0].selectize;
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-file.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initEditor = function(){
	    ...
	    this.initEditorCheckboxes();
	  };
	  o.initEditorContainer = function(){
	    this.initEditorContainerJqCm();
	  };
	  o.initEditorEvents = function(){
	    this.initEditorEventsJqCm();
	  };
	  o.initEditorButtons = function(){
	    this.initEditorButtonsJq();
	  };
	  o.initEditorCheckboxes = function(){
	    this.initEditorCheckboxesJqIc();
	  };
	  o.editorCreate = function(o){
	    return this.editorCreateCm(o);
	  };
	  o.editorSetValue = function(o){
	    this.editorSetValueCm(o);
	  };
	  o.editorGetValue = function(input){
	    return this.editorGetValueCm(input);
	  };
	  ...
	  o.initEditorContainerJqCm = function(){
	    this.editors.notes = this.editorCreate(this.props.editors.notes);
	  };
	  o.initEditorEventsJqCm = function(){
	    var _this, onchange, i$, ref$;
	    _this = this;
	    onchange = function(){
	      var value, run, save;
	      value = _this.editors.notes.getValue();
	      _this.fileSaveSync({
	        input: 'notes',
	        value: value
	      });
	      run = $('#content__cmd__run__auto').prop('checked');
	      save = $('#content__cmd__save__auto').prop('checked');
	    ...
	    function fn$(input){
	      this.editors[input].on('change', onchange);
	    }
	  };
	  o.initEditorButtonsJq = function(){};
	  o.initEditorCheckboxesJqIc = function(){};
	  o.editorCreateCm = function(o){
	  ...
	  o.editorToggleLintJqCm = function(o){
	    var _state;
	    _state = $('#' + o.lintId).prop('checked');
	    if (_state) {
	      this.editors[o.input].setOption('lint', true);
	    } else {
	      this.editors[o.input].setOption('lint', false);
	    }
	  };
	  o.editorSetValueCm = function(o){
	    this.editors[o.input].setValue(o.value);
	  };
	  o.editorSetModeCm = function(o){
	    ...
	    this.editors[o.input].setOption('mode', modes[o.mode]);
	  };
	  o.editorGetValueCm = function(input){
	    return this.editors[input].getValue();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-editor.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputCreateHashurlSelector = function(){
	    return this.outputCreateHashurlSelectorJqSz();
	  };
	  o.outputCreateOutputSelector = function(){
	    return this.outputCreateOutputSelectorJqSz();
	  };
	  o.outputExtMd = function(src){
	    this.outputExtMdJq(src);
	  };
	  o.outputExtHtml = function(src){
	    this.outputExtHtmlJq(src);
	  };
	  o.outputExtJade = function(src){
	    this.outputExtJadeJq(src);
	  };
	  o.outputExtJs = function(src){
	    this.outputExtJsJq(src);
	  };
	  o.outputExtLs = function(src){
	    this.outputExtLsJq(src);
	  };
	  o.initOutputJs = function(){
	    var _this;
	    _this = this;
	    console.log('Output!');
	    this.urlhash = this.outputCreateHashurlSelector();
	    this.urlhash.setValue('#/');
	    this.output = this.outputCreateOutputSelector();
	    this.output.setValue('iframe');
	    this.outputs.md = function(src){
	      _this.outputExtMd(src);
	    };
	    this.outputs.html = function(src){
	      _this.outputExtHtml(src);
	    };
	    this.outputs.jade = function(src){
	      _this.outputExtJade(src);
	    };
	    this.outputs.js = function(src){
	      _this.outputExtJs(src);
	    };
	    this.outputs.ls = function(src){
	      _this.outputExtLs(src);
	    };
	  };
	  o.outputRunJs = function(o){
	    this.outputs[o.ext](o.src);
	  };
	  o.outputCreateHashurlSelectorJqSz = function(){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	        ...
	        searchField: 'name',
	        onChange: function(value){
	          console.log('Output:Hashurl:Change', value);
	        },
	        create: function(value){
	          var woHashUrl;
	    ...
	    return $('#content__main__output__urlhash').selectize(config())[0].selectize;
	  };
	  o.outputCreateOutputSelectorJqSz = function(){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	        ...
	        searchField: 'name',
	        onChange: function(value){
	          console.log('Output:Output:Change', value);
	        },
	        create: false
	      };
	    };
	    return $('#content__main__output__output').selectize(config())[0].selectize;
	  };
	  o.outputExtMdJq = function(src){
	    var html, output_init, output;
	    console.log('Output:Md', src);
	    html = function(o){
	    ...
	    $('<iframe id="content__output__iframe"></iframe>').appendTo('#content__output__holder');
	    ...
	    output.open();
	    output.write(html({
	      style: this.sources.primer_css + '\n' + 'body { font-size: 16px; }',
	      content: marked(src),
	      script: ''
	    }));
	    output.close();
	  };
	  o.outputExtHtmlJq = function(src){
	    var _this, _js, _css, js, css, output_init, output, i$, len$;
	    _this = this;
	    console.log('Output:Html', src);
	    _js = [];
	    _css = [];
	    js = '';
	    css = '';
	    ...
	    output.close();
	    function fn$(i, el){
	      css += '<style>' + this.files.selections.notes[el].src + '</style>\r\n';
	    }
	    function fn1$(i, el){
	      js += '<' + 'script>' + this.files.selections.notes[el].src + '</' + 'script>\r\n';
	    }
	  };
	  o.outputExtJsJq = function(src){
	    var html, output_init, output;
	    console.log('Output:Js', src);
	    html = function(script){
	      return '<!DOCTYPE html><html><head><style>' + '</style></head><body>' + '<script>' + script + '</script>' + '</body></html>';
	    };
	    $('#content__output__iframe').remove();
	    $('<iframe id="content__output__iframe"></iframe>').appendTo('#content__output__holder');
	    output_init = document.getElementById('content__output__iframe');
	    output = output_init.contentDocument || output_init.contentWindow.document;
	    output.open();
	    output.write(html(src));
	    output.close();
	  };
	  o.outputExtJadeJq = function(src){
	    var html;
	    console.log('Output:Jade', src);
	    html = jade.render(src, {
	      pretty: true
	    });
	    this.outputExtHtml(html);
	  };
	  o.outputExtLsJq = function(src){
	    var js;
	    console.log('Output:Ls', src);
	    js = LiveScript.compile(src, {
	      bare: true
	    });
	    this.outputExtJs(js);
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-output.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.utilCreateExportSelector = function(o){
	    return this.utilCreateExportSelectorJqSz(o);
	  };
	  o.utilCreateImportSelector = function(o){
	    return this.utilCreateImportSelectorJqSz(o);
	  };
	  o.utilExportInput = function(input){
	    this.utilExportInputSz(input);
	  };
	  o.utilImportInput = function(o){
	    this.utilImportInputJs(o);
	  };
	  o.utilExportOutput = function(input){
	    this.utilExportOutputJs(input);
	  };
	  o.utilExportInputAll = function(input){
	    this.utilExportInputAllSz(input);
	  };
	  o.utilImportInputAll = function(o){
	    this.utilImportInputJs(o);
	  };
	  o.utilExportInputFile = function(input){
	    this.utilExportInputFileJs(input);
	  };
	  o.utilExportInputZip = function(input){
	    this.utilExportInputZipJs(input);
	  };
	  o.utilExportInputJson = function(input){
	    this.utilExportInputJsonJs(input);
	  };
	  o.utilExportOutputHtml = function(input){
	    this.utilExportOutputHtmlJs(input);
	  };
	  o.utilImportInputFile = function(o){
	    this.utilImportInputFileJs(o);
	  };
	  o.utilImportInputJson = function(o){
	    this.utilImportInputJsonJs(o);
	  };
	  o.utilExportInputZipAll = function(input){
	    this.utilExportInputZipAllJs(o);
	  };
	  o.utilExportInputJsonAll = function(input){
	    this.utilExportInputJsonAllJs(o);
	  };
	  o.utilImportInputJsonAll = function(o){
	    return this.utilImportInputJsonAllJs(o);
	  };
	  o.initUtilJqSz = function(){
	    var _this;
	    _this = this;
	    console.log('Util!');
	    this.utils.selectors.inputs = {
	      notes: {
	        'export': this.utilCreateExportSelector(this.props.utils.notes['export']),
	        'import': this.utilCreateImportSelector(this.props.utils.notes['import'])
	      }
	    };
	    this.utils.selectors.inputs.notes['export'].setValue('file');
	    this.utils.selectors.inputs.notes['import'].setValue('file');
	    this.utils.selectors.output = {
	      'export': this.utilCreateExportSelector(this.props.utils.output['export']),
	      'import': this.utilCreateImportSelector(this.props.utils.output['import'])
	    };
	    this.utils.selectors.output['export'].setValue('html');
	    this.utils.selectors.output['import'].setValue('json');
	    $('#content__inputs__notes__export__button').click(function(){
	      _this.utilExportInput('notes');
	    });
	    $('#content__inputs__notes__import__button').change(function(){
	      _this.utilImportInput({
	        input: 'notes',
	        file: this.files[0]
	      });
	    });
	  };
	  o.utilExportInputSz = function(input){
	    var _this, type, exporter;
	    _this = this;
	    console.log('export:' + input);
	    type = this.utils.selectors.inputs[input]['export'].getValue();
	    exporter = {
	      file: function(){
	        _this.utilExportInputFile(input);
	      },
	      zip: function(){
	        _this.utilExportInputZip(input);
	      },
	      json: function(){
	        _this.utilExportInputJson(input);
	      }
	    };
	    exporter[type]();
	  };
	  o.utilExportInputFileJs = function(input){
	    var file, ext, blob, date, name;
	    console.log('export:file', input);
	    file = this.editors[input].getValue();
	    ext = this.exts.selectors[input].getValue();
	    blob = new Blob([file]);
	    date = moment().format('MMM[]Do-h[]mm[]a');
	    name = input + '-' + date + '.' + ext;
	    saveAs(blob, name);
	  };
	  o.utilExportInputZipJs = function(input){
	    var zip, i$, ref$, blob, date, name;
	    console.log('export:zip', input);
	    zip = new JSZip();
	    for (i$ in ref$ = this.files.selections[input]) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    blob = zip.generate({
	      type: 'blob'
	    ...
	    name = input + '-' + date + '.zip';
	    saveAs(blob, name);
	    function fn$(file, fileProps){
	      zip.file(file + '.' + fileProps.ext, fileProps.src);
	    }
	  };
	  o.utilExportInputJsonJs = function(input){
	    var file, blob, date, name;
	    console.log('export:json', input);
	    file = JSON.stringify(this.files.selections[input], null, 2);
	    blob = new Blob([file]);
	    date = moment().format('MMM[]Do-h[]mm[]a');
	    name = input + '-' + date + '.json';
	    saveAs(blob, name);
	  };
	  o.utilImportInputJs = function(o){
	    var _this, reader;
	    _this = this;
	    reader = new FileReader();
	    reader.readAsText(o.file);
	    reader.onload = function(e){
	      var file, type, importer;
	      file = e.target.result;
	      type = _this.utils.selectors.inputs[o.input]['import'].getValue();
	      console.log('import', type, file);
	      importer = {
	        file: function(){
	          _this.utilImportInputFile({
	            input: o.input,
	            file: file
	          });
	        },
	        json: function(){
	          _this.utilImportInputJson({
	            input: o.input,
	            file: file
	          });
	        }
	  ...
	  o.utilImportInputFileJs = function(o){
	    console.log('import:input:file', o.input);
	    this.editors[o.input].getDoc().setValue(o.file);
	  };
	  o.utilImportInputJsonJs = function(o){
	    var files, i$, file;
	    this.fileResetDefaults();
	    files = JSON.parse(o.file);
	    console.log('import:input:json', o.input, files);
	    for (i$ in files) {
	      (fn$.call(this, i$, files[i$]));
	    }
	    file = this.files.selections[o.input]['index'];
	    this.editors[o.input].setValue(file.src);
	    this.exts.selectors[o.input].setValue(file.ext);
	    function fn$(file, fileProps){
	      this.files.selections[o.input][file] = fileProps;
	      this.files.selectors[o.input].addOption({
	        name: file,
	        value: file
	      });
	  ...
	  o.utilCreateExportSelectorJqSz = function(o){
	    var config;
	    config = function(){
	      return {
	        maxItems: 1,
	        ...
	        onChange: function(value){
	          ...
	          console.log('Util:Export:Change:' + (o.input || o.output), value);
	        },
	        create: false
	      };
	    };
	  ...
	  o.utilCreateImportSelectorJqSz = function(o){
	    var config;
	    config = function(){
	      return {
	        maxItems: 1,
	        ...
	        onChange: function(value){
	          ...
	          console.log('Util:Import:Change:' + (o.input || o.output), value);
	        },
	        create: false
	      };
	    };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-util.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initOptionJs = function(){
	    ...
	    _this = this;
	    console.log('Options!');
	    this.options.selectors.data = {
	      indexeddb: this.optionCreateDataSelector({
	        id: 'content__options__data__indexeddb__table',
	        options: [
	          {
	            name: 'bible'
	          }, {
	    ...
	    this.options.selectors.data.indexeddb.setValue('web');
	    $('#content__options__data__indexeddb__reinit').click(function(){
	      var table;
	      table = _this.options.selectors.data.indexeddb.getValue();
	      $('#app').html('');
	      $('#app').html(_this.templates['default']);
	  ...
	  o.optionCreateDataSelector = function(o){
	    var config;
	    config = function(){
	      return {
	        maxItems: 1,
	        ...
	        onChange: function(value){
	          ...
	          console.log('Options:Change:' + (o.input || o.output), value);
	        },
	        create: false
	      };
	    };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-option.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.initData = function(o){
	    this.initDataJs(o);
	  };
	  o.dataCreate = function(attrs, cb){
	    this.dataCreateMm(attrs, cb);
	  };
	  o.dataUpdate = function(id, attrs, cb){
	    this.dataUpdateJs(id, attrs, cb);
	  };
	  o.dataFind = function(id, cb){
	    this.dataFindJs(id, cb);
	  };
	  o.dataFindAll = function(cb){
	    this.dataFindAllJs(cb);
	  };
	  o.dataDestroy = function(id, cb){
	    this.dataDestroyJs(id, cb);
	  };
	  o.dataSave = function(){
	    this.dataSaveJs();
	  };
	  o.initDataJs = function(o){
	    console.log('Data!');
	    this.data = new this.Datas[o.adapter](o.params || {});
	  };
	  o.dataCreateMm = function(attrs, cb){
	    var i$, ref$;
	    ...
	    this.data.create(attrs, cb);
	    function fn$(i, el){
	      attrs['input_' + i] = el;
	    }
	  };
	  o.dataUpdateJs = function(id, attrs, cb){
	    this.data.update(id, attrs, cb);
	  };
	  o.dataFindJs = function(id, cb){
	    this.data.find(id, cb);
	  };
	  o.dataFindAllJs = function(cb){
	    this.data.findAll(cb);
	  };
	  o.dataDestroyJs = function(id, cb){
	    this.data.destroy(id, cb);
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.initRouter = function(){
	    this.initRouterVendor();
	  };
	  o.routerCreate = function(o){
	    this.routerCreateDr(o);
	  };
	  o.routerSetById = function(id){
	    this.routerSetByIdDr(id);
	  };
	  o.initRouterVendor = function(){
	    console.log('Router!');
	    this.routerCreate(this.props.router);
	  };
	  o.routerCreateDr = function(o){
	    var _this, routes;
	    _this = this;
	    routes = {};
	    routes['/id/:id'] = function(id){
	      _this.id = id;
	      _this.fileResetDefaults();
	      _this.cmdLoadById();
	    };
	    routes['/data-add'] = function(id){
	      _this.dataCreate({}, function(attrs){
	        console.log('/data-add', attrs.id);
	        _this.routerSetById(attrs.id);
	      });
	    };
	    routes['/data-list'] = function(id){
	      _this.dataFindAll(function(data){
	        console.log(data);
	      });
	    };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\component\jquery\lib\component-router.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var props;
	props = {
	  title: 'rcx-frontend-html-css-js',
	  cmd: {},
	  files: {
	    html: {
	      input: 'html',
	      id: 'content__inputs__html__file',
	      exts: [
	        {
	          name: 'html'
	        }, {
	    ...
	    css: {
	      input: 'css',
	      id: 'content__inputs__notes__file',
	      exts: [
	        {
	          name: 'cs'
	        }, {
	  ...
	  editors: {
	    html: {
	      input: 'html',
	      id: 'content__inputs__html__editor',
	      type: 'text/html',
	      ext: 'html'
	    },
	    css: {
	      input: 'css',
	      id: 'content__inputs__css__editor',
	      type: 'text/css',
	      ext: 'css',
	      lint: true
	    },
	    js: {
	      input: 'js',
	      id: 'content__inputs__js__editor',
	    ...
	    notes: {
	      input: 'notes',
	      id: 'content__inputs__notes__editor',
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\lib\props\props.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\data\static\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v1\data\indexeddb\data.ls.map
