	...
	Component = function(Component){
	  ...
	  o.exportMakeAppJq = function(o){
	    ...
	    $('#content__app__export').click(function(){
	      ...
	      entity = _this.appFrontGetValue().split('/');
	      table = _this.app.entities[entity[0]][entity[1]].table;
	      exporter = {
	        value: function(o){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.importAppDataZip = function(o){
	    this.importAppDataZipJs(o);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.appWorkJobValueMakeJs = function(o){
	    ...
	    for (i$ = 0, len$ = (ref$ = this.app.entities.work.job.columns).length; i$ < len$; ++i$) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    this.app.refresh();
	    function fn$(i, el){
	  ...
	  o.appWorkJobValueOnChangeJs = function(o){
	    ...
	    cb = function(attrs){
	      ...
	      for (i$ = 0, len$ = (ref$ = _this.app.entities.work.job.columns).length; i$ < len$; ++i$) {
	        (fn$.call(this, i$, ref$[i$]));
	      }
	      function fn$(i, el){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	    ...
	    config = function(){
	      return {
	        ...
	        onChange: function(value){
	          ...
	          _this.appValueReset();
	          _this.appFrontMakeTemplate(props);
	          _this.appFrontMakeApp(props);
	        },
	        create: false
	      };
	    };
	  ...
	  o.appFrontMakeTemplateJq = function(o){
	    ...
	    $('#content__app').html(this.templates.app[o.group][o.name]);
	  };
	  o.appFrontMakeAppJs = function(o){
	    ...
	    make = this.app.entities[o.group][o.name].name + 'Make';
	    this[make]();
	  };
	};
	if (true) {
