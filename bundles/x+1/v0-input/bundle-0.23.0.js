...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(30);
	Stores = {
	  'static': __webpack_require__(31),
	  indexeddb: __webpack_require__(32)
	};
	templates = {
	  layout: {
	    split: __webpack_require__(34),
	    split_vtab: __webpack_require__(35)
	  },
	  app: {
	    time: __webpack_require__(36)
	  }
	};
	samples = {
	  input_notes: __webpack_require__(37)
	};
	vendors = {
	  highlight_js: __webpack_require__(38),
	  highlight_css: __webpack_require__(39),
	  katex_css: __webpack_require__(40),
	  katex_js: __webpack_require__(41),
	  katex_auto_js: __webpack_require__(42),
	  primer_css: __webpack_require__(43)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.dataMakeJs = function(o){
	    ...
	    params = o.params || {};
	    this.datas[data] = new this.Stores[adapter](params);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runGetIncludes = function(o){
	    return this.runGetIncludesJs(o);
	  };
	  o.runGetConfig = function(o){
	    return this.runGetConfigJs(o);
	  };
	  o.runGetImports = function(o){
	    this.runGetIncludesJs(o);
	  };
	  o.initRunJq = function(){
	    var _this;
	    console.log('Run!');
	    _this = this;
	  ...
	  o.runDataGetImportsJs = function(o){};
	};
	if (true) {
	  module.exports = Component;
	}
