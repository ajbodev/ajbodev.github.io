...
/***/ function(module, exports, __webpack_require__) {
	...
	Stores = {
	  'static': __webpack_require__(34),
	  indexeddb: __webpack_require__(35),
	  firebase: __webpack_require__(37)
	};
	templates = {
	  layout: {
	    split: __webpack_require__(38),
	    split_vtab: __webpack_require__(39)
	  },
	  app: {
	  ...
	  admin: {
	    inputs: {
	      list_data: __webpack_require__(41)
	    }
	  }
	};
	samples = {
	  input_notes: __webpack_require__(42)
	};
	vendors = {
	  highlight_js: __webpack_require__(43),
	  highlight_css: __webpack_require__(44),
	  katex_css: __webpack_require__(45),
	  katex_js: __webpack_require__(46),
	  katex_auto_js: __webpack_require__(47),
	  primer_css: __webpack_require__(48)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.dataMainCreateMm = function(o){
	    ...
	    this.datas.main.main.create(attrs, o.cb);
	    function fn$(i, el){
	      attrs[i] = el;
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.layoutMakeContainer = function(o){
	    return this.layoutMakeContainerJqSz(o);
	  };
	  ...
	  o.layoutMakeContainerJqSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.frameWriteJqDm = function(o){
	    var _this, frame, content;
	    console.log('Frame:Write');
	    _this = this;
	    frame = this.frameMakeContainer();
	    frame.open();
	    content = $('<div>' + o.content + '</div>');
	    content.find('[data-include]').each(function(){
	      var name, file, bundle;
	      name = $(this).data('include');
	      file = o.files[name + ''];
	      bundle = _this.runs[file.ext]({
	        src: file.src,
	        type: 'compile'
	      });
	      $(this).append(bundle);
	    });
	    frame.write(content.html());
	    frame.close();
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runBundleImports = function(o){
	    this.runBundleImportsJs(o);
	  };
	  ...
	  o.runPreStartJs = function(o){
	    ...
	    if (config && config.includes) {
	      params.src += this.runBundleIncludes({
