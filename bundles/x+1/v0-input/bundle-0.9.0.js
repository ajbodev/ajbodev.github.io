...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputLoadExtsJs = function(o){
	    console.log('Input:Load:Exts');
	  };
	  o.inputLoadModesJs = function(o){
	    console.log('Input:Load:Modes');
	  };
	  o.inputLoadEditorsJs = function(o){
	    console.log('Input:Load:Editors');
	  };
	  ...
	  o.routeMakeDr = function(o){
	    ...
	    routes = {
	      ...
	      '/data-create': function(){
	        var cb;
	        cb = function(attrs){
	          console.log('/data-add', attrs.id);
	          _this.routerSetById(attrs.id);
	        };
	        _this.dataCreate({
	          cb: cb
	        });
