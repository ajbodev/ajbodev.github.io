...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(28);
	Datas = {
	  'static': __webpack_require__(29),
	  dexie: __webpack_require__(30)
	};
	templates = {
	  layout: {
	    'default': __webpack_require__(32),
	    alt: __webpack_require__(33)
	  }
	};
	samples = {
	  input_notes: __webpack_require__(34)
	};
	vendors = {
	  highlight_js: __webpack_require__(35),
	  highlight_css: __webpack_require__(36),
	  katex_css: __webpack_require__(37),
	  katex_js: __webpack_require__(38),
	  katex_auto_js: __webpack_require__(39),
	  primer_css: __webpack_require__(40)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.layoutSetValueSz = function(o){
	    this.layout[o.contlayout][o.entity].setValue(o.value, function(){});
	  };
	  o.layoutGetValueSz = function(o){
	    return this.layout[o.contlayout][o.entity].getValue();
	  };
	};
	if (true) {
	  module.exports = Component;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  /*
	  o.inputLoadJs = (o) !-> # inputs (entity:files)
	    console.log 'Input:Load'
	    for let entity, files of o.inputs
	      @inputs[entity] = files
	      @fileReset   context: 'inputs', entity: entity
	      for file, props of files
	        @fileCreate context: 'inputs', entity: entity, value: props.name
	  ...
	  lists: {
	    data: {
	      index: {
	        ...
	        name: 'main',
	        src: 'data',
	        formatRow: 'srcDataFormatRow',
	        getColumns: 'srcDataGetColumns',
	        editable: 'srcDataMakeEditable',
	        checkall: 'srcDataMakeCheckall'
	      }
	    }
	  },
	  reports: {},
