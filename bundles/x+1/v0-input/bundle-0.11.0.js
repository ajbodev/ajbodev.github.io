...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(27);
	Datas = {
	  'static': __webpack_require__(28),
	  dexie: __webpack_require__(29)
	};
	templates = {
	  layout: {
	    'default': __webpack_require__(31),
	    alt: __webpack_require__(32)
	  }
	};
	samples = {
	  input_notes: __webpack_require__(33)
	};
	vendors = {
	  highlight_js: __webpack_require__(34),
	  highlight_css: __webpack_require__(35),
	  katex_css: __webpack_require__(36),
	  katex_js: __webpack_require__(37),
	  katex_auto_js: __webpack_require__(38),
	  primer_css: __webpack_require__(39)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.frameMakeHtml = function(o){
	    return this.frameMakeHtmlJs(o);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputLoadInputs = function(o){
	    this.inputLoadInputsJs(o);
	  };
	  o.inputLoadFiles = function(o){
	    this.inputLoadFilesJs(o);
	  };
	  o.inputLoadExts = function(o){
	    this.inputLoadExtsJs(o);
	  };
	  o.inputLoadModes = function(o){
	    this.inputLoadModesJs(o);
	  };
	  o.inputLoadEditors = function(o){
	    this.inputLoadEditorsJs(o);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputRunFrameDmJq = function(o){
	    ...
	    css = '';
	    js = '';
	    content = o.src || this.frameMakeHtml({
	      content: o.content || '',
	      script: o.script || '',
	      style: o.style || ''
	    });
	  ...
	  o.outputMakeContainerJs = function(o){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listActionJs = function(o){
	    return console.log('List:Action');
	  };
	};
	if (true) {
	  module.exports = Component;
...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  output: {
	    ...
	    urlhash: {
	      id: 'content__output__urlhash',
	      options: [{
	        value: '#/'
	      }]
	    },
	    ext: {
	      id: 'content__output__ext',
	      options: [
	        {
	          value: 'md'
	        }, {
	    ...
	    iframe: {
	      id: 'content__output__iframe'
	    },
	    editor: {
	      id: 'content__output__editor',
	      type: 'text/x-markdown',
	      ext: 'md'
	    }
	  },
