...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listDataMakeContainerDa = function(o){
	    ...
	    cb = function(list){
	      ...
	      formatter = function(list){
	        ...
	        return formatted;
	        function fn$(i, item){
	          formatted.push(['<input type="checkbox" data-id="' + item.id + '">', '<a onclick="app.component.routerSetById(\'' + item.id + '\')">' + item.id + '</a>', makeSpan(item.id, item.title || '', 'title'), makeSpan(item.id, item.tree || '', 'tree'), makeSpan(item.id, item.labels || '', 'labels'), makeSpan(item.id, item.status || '', 'status'), makeSpan(item.id, item.date || '', 'date'), makeSpan(item.id, item.date_start || '', 'date_start'), makeSpan(item.id, item.date_end || '', 'date_end')]);
	        }
	      };
	      columns = [
	        {
	  ...
	  o.listDataMakeCheckallJq = function(o){
	    return console.log('List:Make:Checkall');
	  };
	  o.listDataRefreshJq = function(o){
	    return console.log('List:Refresh');
	  };
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\data\static\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\data\browser\data-indexeddb-dexie.ls.map
...
/***/ function(module, exports) {
	...
	window.db._init('x_1');
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\data\browser\db-indexeddb-dexie.ls.map
