...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(15);
	Datas = {
	  'static': __webpack_require__(16)
	};
	templates = {
	  'default': __webpack_require__(17),
	  alt: __webpack_require__(18)
	};
	samples = {
	  notes: __webpack_require__(19)
	};
	vendors = {
	  highlight_js: __webpack_require__(20),
	  highlight_css: __webpack_require__(21),
	  katex_css: __webpack_require__(22),
	  katex_js: __webpack_require__(23),
	  katex_auto_js: __webpack_require__(24),
	  primer_css: __webpack_require__(25)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.editorMakeContainer = function(o){
	    return this.editorMakeContainerCm(o);
	  };
	  o.editorMakeAutosave = function(o){
	    this.editorMakeAutosaveJs(o);
	  };
	  ...
	  o.editorSetLint = function(o){
	    this.editorSetLintCm(o);
	  };
	  o.editorGetLint = function(o){
	    return this.editorGetLintCm(o);
	  };
	  ...
	  o.initEditorJs = function(){
	    console.log('Editor!');
	    this.editors.notes = this.editorMakeContainer(this.props.editors.notes);
	    this.editorMakeAutosave({
	      input: 'notes'
	    });
	  };
	  o.editorMakeAutosaveJs = function(o){
	    var _this;
	    _this = this;
	    this.editors[o.input].on('change', function(){
	      _this.inputSave({
	        input: o.input
	      });
	    });
	  };
	  o.editorMakeContainerCm = function(o){
	  ...
	  o.editorGetValueCm = function(o){
	    return this.editors[o.input].getValue();
	  };
	  ...
	  o.editorSetModeCm = function(o){
	    ...
	    mode = modes[o.ext] || o.mode;
	    if (o.input) {
	      this.editors[o.input].setOption('mode', mode);
	    }
	    if (o.output) {
	      this.output.editor.setOption('mode', mode);
	    }
	  };
	  o.editorGetModeCm = function(o){
	    return this.editors[o.input].getOption('mode');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\editor.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initFileJq = function(){
	    ...
	    _this = this;
	    console.log('File!');
	    this.files.notes = this.fileMakeContainer(this.props.files.notes);
	    $('#content__input__notes__destroy').click(function(){
	      var file;
	    ...
	    config = function(){
	      return {
	        ...
	        onChange: function(value){
	          console.log('File:Config:Onchange', value);
	          if (value !== '') {
	            _this.inputSelect({
	              input: o.input,
	              file: value
	        ...
	        create: function(value){
	          console.log('File:Config:Create', value);
	          _this.inputCreate({
	            input: o.input,
	            file: value
	          });
	  ...
	  o.fileSetValueSz = function(o){
	    this.files[o.input].setValue(o.value, function(){});
	  };
	  o.fileGetValueSz = function(o){
	    return this.files[o.input].getValue();
	  };
	  o.fileCreateSz = function(o){
	    this.files[o.input].addOption({
	      value: o.value,
	      label: o.value
	    });
	  };
	  o.fileDestroySz = function(o){
	    var val;
	    val = o.file || this.fileGetValue({
	      input: o.input
	    });
	    if (val !== 'index') {
	      this.files[o.input].removeOption(val);
	    } else {
	      console.log('index cannot be deleted!');
	    }
	  };
	  o.fileResetSz = function(o){
	    this.files[o.input].clearOptions();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\file.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.extSetValue = function(o){
	    this.extSetValueJs(o);
	  };
	  o.extGetValue = function(o){
	    return this.extGetValueJs(o);
	  };
	  o.initExtJs = function(){
	    console.log('Ext!');
	    this.exts.notes = this.extMakeContainer(this.props.exts.notes);
	  };
	  o.extMakeContainerSz = function(o){
	    ...
	    config = function(){
	      return {
	        ...
	        options: o.options,
	        onChange: function(value){
	          console.log('Ext:Config:Onchange', value);
	          if (value !== '') {
	            _this.inputUpdate({
	              input: o.input,
	              ext: value
	  ...
	  o.extSetValueJs = function(o){
	    this.exts[o.input].setValue(o.value, function(){});
	  };
	  o.extGetValueJs = function(o){
	    return this.exts[o.input].getValue();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\ext.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.modeAction = function(o){
	    return this.modeActionJs();
	  };
	  o.initModeJs = function(){
	    console.log('Mode!');
	  };
	  o.modeActionJs = function(){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\mode.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputGetJs = function(o){
	    return this.inputs[o.input][this.input[o.input]];
	  };
	  o.inputSelectJs = function(o){
	    var file;
	    this.input[o.input] = o.file;
	    console.log('Input:Select', o.input, this.input[o.input]);
	    file = this.inputs[o.input][o.file];
	    this.fileSetValue({
	      input: o.input,
	      value: o.file
	    });
	  ...
	  o.inputCreateJs = function(o){
	    console.log('Input:Create', o.input, o.file, o.src, o.ext);
	    this.inputs[o.input][o.file] = {
	      src: o.src || '',
	      ext: o.ext || 'md'
	    };
	    this.fileCreate({
	  ...
	  o.inputFindJs = function(o){
	    console.log('Input:Find', o.input, o.file);
	    return this.inputs[o.input][o.file];
	  };
	  o.inputUpdateJs = function(o){
	    var file, inputFile;
	    console.log('Input:Update', o.input, o.file, o.src, o.ext);
	    if (!o.file) {
	      file = this.fileGetValue({
	        input: o.input
	      });
	      inputFile = this.inputs[o.input][file];
	    } else {
	      inputFile = this.inputs[o.input][o.file];
	    }
	    if (inputFile) {
	      if (o.src) {
	        inputFile.src = o.src;
	  ...
	  o.inputDestroyJs = function(o){
	    console.log('Input:Destroy', o.input, o.file);
	    if (o.file !== 'index') {
	      delete this.inputs[o.input][o.file];
	      this.inputSelect({
	        input: o.input,
	        file: 'index'
	      });
	  ...
	  o.inputResetJs = function(o){
	    ...
	    this.editorSetValue({
	      input: o.input,
	      value: this.inputs[o.input]['index'].src
	    });
	  };
	  o.inputSaveJs = function(o){
	    var fileValue, editorValue;
	    fileValue = this.fileGetValue({
	      input: o.input
	    });
	    editorValue = this.editorGetValue({
	      input: o.input
	    });
	    this.inputUpdate({
	      input: o.input,
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\input.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.cmdRunNotesJs = function(){
	    var input;
	    input = this.inputGet({
	      input: 'notes'
	    });
	    console.log('cmdRun', input);
	    this.outputRun(input);
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\cmd.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputMakeTypeContainer = function(o){
	    return this.outputMakeTypeContainerSz(o);
	  };
	  o.outputMakeUrlhashContainer = function(o){
	    return this.outputMakeUrlhashContainerSz(o);
	  };
	  o.outputMakeExtContainer = function(o){
	    return this.outputMakeExtContainerSz(o);
	  };
	  o.outputMakeEditorContainer = function(o){
	    this.outputMakeEditorContainerJq(o);
	  };
	  o.outputMakeIframeContainer = function(o){
	    this.outputMakeIframeContainerJq(o);
	  };
	  o.outputSetPropValue = function(o){
	    this.outputSetPropValueSz(o);
	  };
	  o.outputGetPropValue = function(o){
	    return this.outputGetPropValueSz(o);
	  };
	  o.outputSetPropEnabled = function(o){
	    this.outputSetPropEnabledSz(o);
	  };
	  o.outputSetPropDisabled = function(o){
	    this.outputSetPropDisabledSz(o);
	  };
	  o.outputGetIframeContainer = function(o){
	    return this.outputGetIframeContainerJqDm(o);
	  };
	  o.outputQueryIframeEachData = function(o){
	    return this.outputQueryIframeEachDataJq(o);
	  };
	  o.outputGetDefaultHtml = function(o){
	    return this.outputGetDefaultHtmlJs(o);
	  };
	  o.outputGetInput = function(o){
	    return this.outputGetInputJs(o);
	  };
	  o.initOutputJs = function(){
	    ...
	    this.outputs = {
	      md: function(o){
	        return _this.outputMd(o);
	      },
	      html: function(o){
	        return _this.outputHtml(o);
	      },
	      jade: function(o){
	        return _this.outputJade(o);
	      },
	      js: function(o){
	        return _this.outputJs(o);
	      },
	      ls: function(o){
	        return _this.outputLs(o);
	      }
	    };
	    this.output = {
	      type: this.outputMakeTypeContainer(this.props.output.type),
	      urlhash: this.outputMakeUrlhashContainer(this.props.output.urlhash),
	      ext: this.outputMakeExtContainer(this.props.output.ext)
	    };
	    this.outputSetPropValue({
	      prop: 'type',
	      value: 'iframe'
	    });
	    this.outputSetPropValue({
	    ...
	    this.outputSetPropDisabled({
	      prop: 'ext'
	    });
	  };
	  o.outputGetIframeContainerJqDm = function(o){
	  ...
	  o.outputQueryIframeEachDataJq = function(o){
	    var list;
	    list = [];
	    $('#content__output__iframe').contents().find(o.query).each(function(i, v){
	      var data;
	  ...
	  o.outputGetInputJs = function(o){
	    ...
	    function fn$(el){
	      var file, output;
	      file = this.inputs[o.input][el];
	      output = this.outputs[file.ext]({
	        src: file.src,
	        type: 'compile'
	      });
	      js += '<' + o.tag + '>' + output + '</' + o.tag + '>\r\n';
	    }
	  };
	  o.outputRunJs = function(o){
	    var input;
	    input = {
	      type: this.outputGetPropValue({
	        prop: 'type'
	      }),
	      src: o.src
	    };
	    this.outputs[o.ext](input);
	  };
	  o.outputMakeTypeContainerSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	        ...
	        onChange: function(value){
	          ...
	          if (value === 'editor') {
	            ...
	            _this.outputSetPropEnabled({
	              prop: 'ext'
	            });
	            _this.outputSetPropValue({
	              prop: 'ext',
	              value: 'html'
	            });
	            _this.outputSetPropDisabled({
	              prop: 'urlhash'
	            });
	          } else {
	            value = 'iframe';
	  ...
	  o.outputMakeUrlhashContainerSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	  ...
	  o.outputMakeExtContainerSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	  ...
	  o.outputMakeEditorContainerJq = function(o){
	    $('#content__output__iframe').remove();
	    $('<textarea id="content__output__editor"></textarea>').appendTo('#content__output__holder');
	    this.output.editor = this.editorMakeContainer({
	      id: 'content__output__editor'
	    });
	    return this.editorSetMode({
	      output: true,
	      ext: 'html'
	    });
	  };
	  o.outputMakeIframeContainerJq = function(o){
	    this.output.editor = null;
	    return $('#content__output__holder').html('<iframe id="content__output__iframe"></iframe>');
	  };
	  o.outputSetPropValueSz = function(o){
	    this.output[o.prop].setValue(o.value, function(){});
	  };
	  o.outputGetPropValueSz = function(o){
	    return this.output[o.prop].getValue();
	  };
	  o.outputSetPropEnabledSz = function(o){
	    return this.output[o.prop].enable();
	  };
	  o.outputSetPropDisabledSz = function(o){
	    return this.output[o.prop].disable();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputMd = function(o){
	    return this.outputMdJs(o);
	  };
	  o.outputMdIframe = function(o){
	    this.outputMdIframeDm(o);
	  };
	  o.outputMdEditor = function(o){
	    this.outputMdEditorJs(o);
	  };
	  o.outputMdCompile = function(o){
	    return this.outputMdCompileMd(o);
	  };
	  o.outputMdJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputMdIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputMdEditor({
	        src: o.src
	      });
	    } else if (o.type === 'compile') {
	      return this.outputMdCompile({
	        src: o.src
	      });
	    }
	  };
	  o.outputMdIframeDm = function(o){
	    var html, iframe;
	    console.log('Output:Md:Iframe', o.src);
	    html = this.outputGetDefaultHtml({
	      style: this.vendors.primer_css + '\n' + this.vendors.highlight_css + '\n' + this.vendors.katex_css + '\n' + 'body { font-size: 16px; }',
	      content: this.outputMd({
	        type: 'compile',
	        src: o.src
	      }),
	    ...
	    iframe = this.outputGetIframeContainer();
	    iframe.open();
	    iframe.write(html);
	    iframe.close();
	  };
	  o.outputMdEditorJs = function(o){
	    console.log('Output:Md:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: this.outputMd({
	        type: 'compile',
	  ...
	  o.outputMdCompileMd = function(o){
	    return marked(o.src);
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\md.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputHtml = function(o){
	    return this.outputHtmlJs(o);
	  };
	  o.outputHtmlIframe = function(o){
	    this.outputHtmlIframeDm(o);
	  };
	  o.outputHtmlEditor = function(o){
	    this.outputHtmlEditorJs(o);
	  };
	  o.outputHtmlJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputHtmlIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputHtmlEditor({
	        src: o.src
	      });
	    }
	  };
	  o.outputHtmlIframeDm = function(o){
	    var _this, scripts, styles, html, iframe, js;
	    _this = this;
	    console.log('Output:Html:Iframe', o.src);
	    scripts = [];
	    styles = [];
	    html = o.src;
	    iframe = this.outputGetIframeContainer();
	    iframe.open();
	    iframe.write(html);
	    scripts = this.outputQueryIframeEachData({
	      query: 'script[data-file]',
	      data: 'file'
	    });
	    js = this.outputGetInput({
	      input: 'notes',
	      files: scripts,
	      tag: 'script'
	    });
	  ...
	  o.outputHtmlEditorJs = function(o){
	    console.log('Output:Html:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: o.src
	    });
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\html.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputJade = function(o){
	    return this.outputJadeJs(o);
	  };
	  o.outputJadeIframe = function(o){
	    this.outputJadeIframeDm(o);
	  };
	  o.outputJadeEditor = function(o){
	    this.outputJadeEditorJs(o);
	  };
	  o.outputJadeCompile = function(o){
	    return this.outputJadeCompileJs(o);
	  };
	  o.outputJadeJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputJadeIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputJadeEditor({
	        src: o.src
	      });
	    } else if (o.type === 'compile') {
	      return this.outputJadeCompile({
	        src: o.src
	      });
	    }
	  };
	  o.outputJadeIframeDm = function(o){
	    var html;
	    html = this.outputJade({
	      type: 'compile',
	      src: o.src
	    });
	    this.outputHtmlIframe({
	      src: html
	    });
	  };
	  o.outputJadeEditorJs = function(o){
	    console.log('Output:Jade:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: this.outputJade({
	        type: 'compile',
	        src: o.src
	      })
	    });
	  ...
	  o.outputJadeCompileJs = function(o){
	    console.log('Output:Jade:Compile', o.src);
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\jade.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputJs = function(o){
	    return this.outputJsJs(o);
	  };
	  o.outputJsIframe = function(o){
	    this.outputJsIframeDm(o);
	  };
	  o.outputJsEditor = function(o){
	    this.outputJsEditorJs(o);
	  };
	  o.outputJsCompile = function(o){
	    return this.outputJsCompileJs(o);
	  };
	  o.outputJsJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputJsIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputJsEditor({
	        src: o.src
	      });
	    } else if (o.type === 'compile') {
	      return this.outputJsCompile({
	        src: o.src
	      });
	    }
	  };
	  o.outputJsIframeDm = function(o){
	    var html, iframe;
	    console.log('Output:Js:Iframe', o.src);
	    html = this.outputGetDefaultHtml({
	      script: this.outputJs({
	        type: 'compile',
	        src: o.src
	      })
	    });
	  ...
	  o.outputJsEditorJs = function(o){
	    console.log('Output:Js:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: o.src
	    });
	  ...
	  o.outputJsCompileJs = function(o){
	    console.log('Output:Js:Compile', o.src);
	    return o.src;
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\js.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputLs = function(o){
	    return this.outputLsJs(o);
	  };
	  o.outputLsIframe = function(o){
	    this.outputLsIframeDm(o);
	  };
	  o.outputLsEditor = function(o){
	    this.outputLsEditorJs(o);
	  };
	  o.outputLsCompile = function(o){
	    return this.outputLsCompileLs(o);
	  };
	  o.outputLsJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputLsIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputLsEditor({
	        src: o.src
	      });
	    } else if (o.type === 'compile') {
	      return this.outputLsCompile({
	        src: o.src
	      });
	    }
	  };
	  o.outputLsIframeDm = function(o){
	    var html, iframe;
	    console.log('Output:Ls:Iframe', o.src);
	    html = this.outputGetDefaultHtml({
	      script: this.outputLs({
	        type: 'compile',
	        src: o.src
	      })
	    });
	  ...
	  o.outputLsEditorJs = function(o){
	    console.log('Output:Ls:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: this.outputLs({
	        type: 'compile',
	  ...
	  o.outputLsCompileLs = function(o){
	    console.log('Output:Ls:Compile', o.src);
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\ls.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.outputCss = function(o){
	    return this.outputCssJs(o);
	  };
	  o.outputCssIframe = function(o){
	    this.outputCssIframeDm(o);
	  };
	  o.outputCssEditor = function(o){
	    this.outputCssEditorJs(o);
	  };
	  o.outputCssCompile = function(o){
	    return this.outputCssCompileJs(o);
	  };
	  o.outputCssJs = function(o){
	    if (o.type === 'iframe') {
	      return this.outputCssIframe({
	        src: o.src
	      });
	    } else if (o.type === 'editor') {
	      return this.outputCssEditor({
	        src: o.src
	      });
	    } else if (o.type === 'compile') {
	      return this.outputCssCompile({
	        src: o.src
	      });
	    }
	  };
	  o.outputCssIframeDm = function(o){
	    var html, iframe;
	    console.log('Output:Css:Iframe', o.src);
	    html = this.outputGetDefaultHtml({
	      script: this.outputCss({
	        type: 'compile',
	        src: o.src
	      })
	    });
	  ...
	  o.outputCssEditorJs = function(o){
	    console.log('Output:Css:Editor', o.src);
	    this.outputSetPropValue({
	      prop: 'editor',
	      value: o.src
	    });
	  ...
	  o.outputCssCompileJs = function(o){
	    console.log('Output:Css:Compile', o.src);
	    return o.src;
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\run\output\css.ls.map
