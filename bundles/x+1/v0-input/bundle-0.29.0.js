...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputRunFrameJq = function(o){
	    ...
	    _this = this;
	    content = $('<div>' + (o.src || this.frameBuildMarkup(o)) + '</div>');
