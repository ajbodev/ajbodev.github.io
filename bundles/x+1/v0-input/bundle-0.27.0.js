	...
	Component = function(Component){
	  ...
	  o.outputRunFrameJs = function(o){
	    ...
	    cb = function(frame){
	      /*
	      styles   = []; style = '';
	      styles   = _this.frameQueryEachData query: 'style[data-include]', data: 'include'
	      style    = _this.runBundleIncludes  includes: styles, format: 'markup', tag: 'style'
	      _this.frameWriteStyle               frame: frame, style: style
	      
	      scripts  = []; script = ''; 
	      scripts  = _this.frameQueryEachData query: 'script[data-include]', data: 'include'
	      script   = _this.runBundleIncludes  includes: scripts, format: 'markup', tag: 'script'
	      _this.frameWriteScript              frame: frame, script: script
...
/***/ function(module, exports) {
	...
	module.exports = "{\n  \"index\":  {\"src\": \"Hi\", \"name\":\"index\", \"ext\":\"++.md\", \"mode\":\"text/x-markdown\"},\n  \"config\": {\"src\": \"{}\", \"name\":\"next\",  \"ext\":\"json\", \"mode\":\"text/application/x-json\"}\n}";
