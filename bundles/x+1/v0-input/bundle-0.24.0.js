...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component, props, Stores, templates, samples, vendors, component;
	Component = __webpack_require__(1);
	props = __webpack_require__(36);
	Stores = {
	  'static': __webpack_require__(37),
	  indexeddb: __webpack_require__(38),
	  firebase: __webpack_require__(40)
	};
	templates = {
	  layout: {
	    split: __webpack_require__(41),
	    split_vtab: __webpack_require__(42)
	  },
	  app: {
	...
	samples = {
	  input_notes: __webpack_require__(44)
	};
	vendors = {
	  highlight_js: __webpack_require__(45),
	  highlight_css: __webpack_require__(46),
	  katex_css: __webpack_require__(47),
	  katex_js: __webpack_require__(48),
	  katex_auto_js: __webpack_require__(49),
	  primer_css: __webpack_require__(50)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.storeAction = function(o){
	    return this.storeActionJs(o);
	  };
	  ...
	  o.storeActionJs = function(o){
	    return console.log('Store:Action');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\store.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.configMakeDataJs = function(o){
	    var config, data, adapter, params;
	    console.log('Config:Make:Data');
	    config = o.config;
	    data = o.data;
	    adapter = this.config[config].index;
	    params = this.config[config][adapter];
	    this.dataMake({
	      data: data,
	      adapter: adapter,
	      params: params
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.defaultMakeConfig = function(o){
	    this.defaultMakeConfigJs(o);
	  };
	  ...
	  o.defaultMakeConfigJs = function(o){
	    console.log('Default:Make:Config');
	    this.config = {
	      layout: 'split',
	      store_notes_data: {
	        index: 'static',
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config\default.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.layoutMakeContainerWindow = function(o){
	    this.layoutMakeContainerWindowJq(o);
	  };
	  o.layoutMakeContainerSelect = function(o){
	    return this.layoutMakeContainerSelectSz(o);
	  };
	  ...
	  o.layoutSelectSetValue = function(o){
	    this.layoutSelectSetValueSz(o);
	  };
	  o.layoutSelectGetValue = function(o){
	    return this.layoutSelectGetValueSz(o);
	  };
	  o.initLayoutJs = function(){
	    console.log('Layout!');
	    this.layoutMakeContainerWindow();
	    this.layout = this.layoutMakeContainerSelect(this.props.layout);
	    this.layoutSelectSetValue({
	      value: this.layoutMatchAliasToTitle({
	        alias: this.config.layout
	      })
	    });
	  };
	  o.layoutMakeContainerWindowJq = function(o){
	    var layout, template;
	  ...
	  o.layoutMakeContainerSelectSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	  ...
	  o.layoutSelectSetValueSz = function(o){
	    this.layout.setValue(o.value, function(){});
	  };
	  o.layoutSelectGetValueSz = function(o){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config\layout.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config\option.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.optionStoreMatchAlias = function(o){
	    return this.optionStoreMatchAliasJs(o);
	  };
	  o.optionStoreSetIndex = function(o){
	    this.optionStoreSetIndexJq(o);
	  };
	  o.optionStoreSetInputs = function(o){
	    this.optionStoreSetInputsJq(o);
	  };
	  ...
	  o.initOptionStoreJs = function(){
	    ...
	    _this = this;
	    this.optionStoreMake({
	      props: this.props.options.stores['notes_data']
	    });
	    this.optionStoreMake({
	      props: this.props.options.stores['notes_repo']
	    });
	    this.optionStoreMake({
	      props: this.props.options.stores['app_data']
	    });
	    this.optionStoreSetDataHeader({
	      title: this.optionStoreMatchAliasToTitle({
	        alias: this.config.store_notes_data.index
	      })
	    });
	  };
	  o.optionStoreMakeJs = function(o){
	    ...
	    props = o.props;
	    this.options.stores[props.store] = this.optionStoreMakeContainer(props);
	    this.optionStoreMakeInputsAutoConfig(props);
	    this.optionStoreSetInputs(props);
	    return this.optionStoreSetValue({
	      store: props.store,
	      value: this.optionStoreMatchAliasToTitle({
	        alias: this.config[props.config].index
	      })
	    });
	  };
	  o.optionStoreMakeContainerSz = function(o){
	    var _this, config, id, configSz;
	    ...
	    configSz = function(){
	      return {
	        ...
	        onChange: function(value){
	          ...
	          _this.config[config].index = adapter;
	          _this.optionStoreSetInputs({
	            config: o.config,
	            id: o.id,
	            props: ['db_url', 'table']
	          });
	          _this.optionStoreSetDataHeader({
	            title: value
	          });
	          _this.configSet({
	            config: 'store',
	            props: _this.config.store
	          });
	        },
	        create: false
	      };
	  ...
	  o.optionStoreMakeInputsAutoConfigJq = function(o){
	    ...
	    function fn$(i, prop){
	      ...
	      $('#' + id).on('change', function(){
	        var adapter, val;
	        adapter = _this.config[config].index;
	        val = $(this).val();
	        _this.config[config][adapter][prop] = val;
	        _this.configSet({
	          config: 'store',
	          props: _this.config.store
	        });
	  ...
	  o.optionStoreSetInputsJq = function(o){
	    var _this, config, adapter, props, i$, len$;
	    console.log('Option:Store:Set:Input');
	    _this = this;
	    config = o.config;
	    adapter = this.config[config].index;
	    props = o.props;
	  ...
	  o.optionStoreMatchTitleToAliasJs = function(o){
	    var titles;
	    console.log('Option:Store:Match:Title:To:Alias');
	    titles = {
	      'Static': 'static',
	  ...
	  o.optionStoreSetDataHeaderJq = function(o){
	    ...
	    $('#header__data__title').html(o.title);
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config\option\store.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.optionRunLoadScript = function(o){
	    this.optionRunLoadScriptDmJq(o);
	  };
	  o.initOptionRunJs = function(){
	    console.log('Option:Run!');
	    this.optionRunMakeLoadable(this.props.options.runs.transpiler_babel);
	    this.optionRunMakeLoadable(this.props.options.runs.transpiler_ts);
	  };
	  ...
	  o.optionRunLoadScriptDmJq = function(o){
	    var script;
	    console.log('Option:Run:Load:Script');
	    script = document.createElement('script');
	    script.src = $('#' + o.id + '__src').val();
	    script.onload = function(){
	      console.log('Loaded', o.name);
	    };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\config\option\run.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.mainAction = function(o){
	    return this.mainActionJs(o);
	  };
	  ...
	  o.mainActionJs = function(o){
	    return console.log('Main:Action');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.extMakeValues = function(o){
	    return this.extMakeValuesSz(o);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.frameWrite = function(o){
	    this.frameWriteJqDm(o);
	  };
	  o.frameWriteContent = function(o){
	    this.frameWriteContentDm(o);
	  };
	  o.frameWriteStyle = function(o){
	    this.frameWriteStyleDm(o);
	  };
	  o.frameWriteScript = function(o){
	    this.frameWriteScriptDm(o);
	  };
	  o.frameInsertContent = function(o){
	    this.frameInsertContentJqDm(o);
	  };
	  ...
	  o.frameInsertContentJqDm = function(o){
	    var i$, ref$, len$;
	    console.log('Frame:Write');
	    for (i$ = 0, len$ = (ref$ = o.contents).length; i$ < len$; ++i$) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    function fn$(i, el){
	      el;
	  ...
	  o.frameWriteJqDm = function(o){
	    var content, cb, frame;
	    console.log('Frame:Write');
	    content = o.content;
	    cb = o.cb;
	    frame = this.frameMakeContainer();
	    frame.open();
	    this.frameWriteContent({
	      frame: frame,
	      content: content
	    });
	    if (cb) {
	  ...
	  o.frameWriteContentDm = function(o){
	    console.log('Frame:Write:Content');
	    o.frame.write(o.content);
	  };
	  o.frameWriteScriptDm = function(o){
	    console.log('Frame:Write:Script');
	    o.frame.write(o.script);
	  };
	  o.frameWriteStyleDm = function(o){
	    console.log('Frame:Write:Style');
	    o.frame.write(o.style);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\result.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initOutputJs = function(){
	    ...
	    console.log('Output!');
	    _this = this;
	    this.results.outputs.index = this.resultMakeContainer(this.props.result.outputs.index);
	    this.resultSetValue({
	      context: 'outputs',
	      entity: 'index',
	      value: 'frame'
	  ...
	  o.outputRunFrameJs = function(o){
	    var _this, content, cb;
	    console.log('Output:Run:Frame');
	    _this = this;
	    content = o.src || this.frameBuildMarkup(o);
	    cb = function(frame){
	      var styles, style, scripts, script;
	      styles = [];
	      style = '';
	      styles = _this.frameQueryEachData({
	        query: 'style[data-include]',
	        data: 'include'
	      });
	      style = _this.runBundleIncludes({
	        includes: styles,
	        format: 'markup',
	        tag: 'style'
	      });
	      _this.frameWriteStyle({
	        frame: frame,
	        script: style
	      });
	      scripts = [];
	      script = '';
	      scripts = _this.frameQueryEachData({
	        query: 'script[data-include]',
	        data: 'include'
	      });
	      script = _this.runBundleIncludes({
	        includes: scripts,
	        format: 'markup',
	        tag: 'script'
	      });
	      _this.frameWriteScript({
	        frame: frame,
	        script: script
	      });
	      /*
	      contents = []; content = ''; 
	      contents = _this.frameQueryEachData query: 'div[data-include]', data: 'include'
	      content  = _this.runGetIncludes     includes: contents, format: 'markup', tag: 'div'
	      _this.frameInsertContent            frame: frame, script: script
	      
	      $ '#content__output__index__frame' .contents! .find 'div[data-include]' .each (e, v) !->
	        include = ($ @ .data 'include') + ''
	        file = _this.inputs['notes'][include]
	        v.innerHTML = _this.runs[file.ext] src: file.src, run: 'compile'
	      */
	    };
	    this.frameWrite({
	      content: content,
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runPreStart = function(o){
	    return this.runPreStartJs(o);
	  };
	  o.runStart = function(o){
	    return this.runStartJs(o);
	  };
	  o.runBundleIncludes = function(o){
	    return this.runBundleIncludesJs(o);
	  };
	  o.runGetConfig = function(o){
	    return this.runGetConfigJs(o);
	  };
	  o.runGetImports = function(o){
	    this.runGetImportsJs(o);
	  };
	  o.initRunJqIc = function(){
	    ...
	    this.runs = {
	      ...
	      'ls': function(o){
	        return _this.runTranspilerLs(o);
	      },
	      'ts': function(o){
	        return _this.runTranspilerTs(o);
	      },
	      'babel.js': function(o){
	  ...
	  o.runPreStartJs = function(o){
	    var config, input, output, run, params;
	    console.log('Run:Pre:Start');
	    ...
	    if (config.includes) {
	      params.src += this.runGetIncludes({
	        includes: config.includes,
	        format: 'text'
	      });
	    }
	    this.runs[run](params);
	  };
	  o.runStartJs = function(o){
	    var params;
	    ...
	    this.outputRun(params);
	  };
	  o.runBundleIncludesJs = function(o){
	    var entity, tag, format, includes, str, i$, len$;
	    console.log('Run:Get:Includes');
	    ...
	    for (i$ = 0, len$ = includes.length; i$ < len$; ++i$) {
	      (fn$.call(this, includes[i$]));
	    }
	    return str;
	    function fn$(fileOutput){
	      var fileInput, run, props, output;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\default\html.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\default\css.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\default\js.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runMarkdownMarkedppFrame = function(o){
	    this.runMarkdownMarkedppFrameJs(o);
	  };
	  o.runMarkdownMarkedppEditor = function(o){
	    this.runMarkdownMarkedppEditorJs(o);
	  };
	  ...
	  o.runMarkdownMarkedppFrameJs = function(o){
	    console.log('Run:Md:Frame');
	    o.content = this.runMarkdownMarkedppCompile({
	      src: o.src
	    });
	  ...
	  o.runMarkdownMarkedppEditorJs = function(o){
	    console.log('Run:Md:Editor');
	    o.src = this.runMarkdownMarkedppCompile({
	      src: o.src
	    });
	    this.runStart(o);
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\markdown\marked++.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runTemplateJadeJs = function(o){
	    ...
	    run = {
	      frame: function(){
	        _this.runTemplateJadeFrame({
	          src: o.src
	        });
	      },
	      editor: function(){
	        _this.runTemplateJadeEditor({
	          src: o.src
	        });
	      },
	      compile: function(){
	        return _this.runTemplateJadeCompile({
	          src: o.src
	        });
	      }
	    };
	  ...
	  o.runTemplateJadeFrameJs = function(o){
	    console.log('Run:TemplateJade:Frame');
	    this.outputRunFrame({
	      src: this.runTemplateJadeCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTemplateJadeEditorJs = function(o){
	    console.log('Run:TemplateJade:Editor');
	  ...
	  o.runTemplateJadeCompileJd = function(o){
	    console.log('Run:TemplateJade:Compile');
	    return TemplateJade.render(o.src, {
	      pretty: true
	    });
	  };
	};
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\template\jade.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.runTranspilerLs = function(o){
	    return this.runTranspilerLsJs(o);
	  };
	  o.runTranspilerLsFrame = function(o){
	    this.runTranspilerLsFrameJs(o);
	  };
	  o.runTranspilerLsEditor = function(o){
	    this.runTranspilerLsEditorJs(o);
	  };
	  o.runTranspilerLsCompile = function(o){
	    return this.runTranspilerLsCompileLs(o);
	  };
	  o.runTranspilerLsJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	        _this.runTranspilerLsFrame({
	          src: o.src
	        });
	      },
	      editor: function(){
	        _this.runTranspilerLsEditor({
	          src: o.src
	        });
	      },
	      compile: function(){
	        return _this.runTranspilerLsCompile({
	          src: o.src
	        });
	      }
	    };
	  ...
	  o.runTranspilerLsFrameJs = function(o){
	    console.log('Run:Ls:Frame');
	    this.outputRunFrame({
	      script: this.runTranspilerLsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerLsEditorJs = function(o){
	    console.log('Run:Ls:Editor');
	    this.outputRunEditor({
	      src: this.runTranspilerLsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerLsCompileLs = function(o){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\transpiler\ls.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.runTranspilerTs = function(o){
	    return this.runTranspilerTsJs(o);
	  };
	  o.runTranspilerTsFrame = function(o){
	    this.runTranspilerTsFrameJs(o);
	  };
	  o.runTranspilerTsEditor = function(o){
	    this.runTranspilerTsEditorJs(o);
	  };
	  o.runTranspilerTsCompile = function(o){
	    return this.runTranspilerTsCompileTs(o);
	  };
	  o.runTranspilerTsJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	        _this.runTranspilerTsFrame({
	          src: o.src
	        });
	      },
	      editor: function(){
	        _this.runTranspilerTsEditor({
	          src: o.src
	        });
	      },
	      compile: function(){
	        return _this.runTranspilerTsCompile({
	          src: o.src
	        });
	      }
	    };
	  ...
	  o.runTranspilerTsFrameJs = function(o){
	    console.log('Run:Ts:Frame');
	    this.outputRunFrame({
	      script: this.runTranspilerTsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerTsEditorJs = function(o){
	    console.log('Run:Ts:Editor');
	    this.outputRunEditor({
	      src: this.runTranspilerTsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerTsCompileTs = function(o){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\transpiler\ts.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runTranspilerBabelJs = function(o){
	    ...
	    run = {
	      frame: function(){
	        _this.runTranspilerBabelFrame({
	          src: o.src
	        });
	      },
	      editor: function(){
	        _this.runTranspilerBabelEditor({
	          src: o.src
	        });
	      },
	      compile: function(){
	        return _this.runTranspilerBabelCompile({
	          src: o.src
	        });
	      }
	    };
	  ...
	  o.runTranspilerBabelFrameJs = function(o){
	    console.log('Run:TranspilerBabel:Frame');
	    this.outputRunFrame({
	      script: this.runTranspilerBabelCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerBabelEditorJs = function(o){
	    console.log('Run:TranspilerBabel:Editor');
	    this.outputRunEditor({
	      src: this.runTranspilerBabelCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTranspilerBabelCompileBb = function(o){
	    console.log('Run:TranspilerBabel:Compile');
	    return TranspilerBabel.transform(o.src, {
	      stage: 2,
	      loose: 'all'
	    }).code;
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\transpiler\babel.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\save.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\load.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.adminAction = function(o){
	    return this.adminActionJs(o);
	  };
	  ...
	  o.adminActionJs = function(o){
	    return console.log('Admin:Action');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.routeMakeDr = function(o){
	    ...
	    routes = {
	      ...
	      '/data-create': function(){
	        _this.routeOnDataCreate();
	      },
	      '/data-list': function(){
	        _this.routeOnDataList();
	      },
	      '/data-destroy/:id': function(id){
	        _this.routeOnDataDestroy({
	          id: id
	        });
	      }
	    };
	  ...
	  o.routeOnDataCreateJs = function(o){
	    var _this, cb;
	    console.log('Route:On:Data:Create');
	    _this = this;
	    cb = function(attrs){
	      _this.routeSetById({
	        id: attrs.id
	  ...
	  o.routeOnDataListJs = function(o){
	    var cb;
	    console.log('Route:On:Data:List');
	    cb = function(data){
	      console.log(data);
	    };
	    this.dataFindAll({
	  ...
	  o.routeOnDataDestroyJs = function(o){
	    console.log('Route:On:Data:Destroy');
	    this.dataDestroy({
	      id: o.id
	    });
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listDataMakeDestroyableJq = function(o){
	    ...
	    _this = this;
	    $('#content__list__data__destroy').click(function(){
	      var ids, i$, len$;
	      ids = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  options: {
	    stores: {
	      notes_data: {
	        id: 'content__option__store__notes__data',
	        config: 'store_notes_data',
	        store: 'notes_data',
	        options: [
	          {
	      ...
	      notes_repo: {
	        id: 'content__option__store__notes__repo',
	        config: 'store_notes_repo',
	        store: 'notes_repo',
	        options: [
	          {
	            value: 'Static'
	      ...
	      app_data: {
	        id: 'content__option__store__app__data',
	        config: 'store_app_data',
	        store: 'app_data',
	        options: [
	          {
	            value: 'Static'
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\static\store.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\browser\store-indexeddb-dexie.ls.map
...
/***/ function(module, exports) {
	...
	window.db = {
	  ...
	  _table: {
	    x_1: {
	      ...
	      repo: {
	        1: '++id, data_id, title, tree, notes, date, labels, status, date_start, date_end',
	        2: ''
	      }
	    }
	  },
	...
	window.db._version('x_1', 1, {
	  notes: db._table.x_1.data[1],
	  notes_repo: db._table.x_1.repo[1]
	});
	window.db._init('x_1');
	/*
	window.db._version 'x_1', 2, do
	  settings:   '++id, settings'
	  notes_data: db._table.x_1.data[1]
	  notes_repo: db._table.x_1.repo[1]
	  app_time:   '++id,'
	  app_jobs:   '++id,'
	  app_people: '++id,'
	*/
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\browser\store-indexeddb-dexie-db.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Store.prototype = {
	  ...
	  create: function(attrs, cb){
	    var id;
	    id = this.db.child(this.table).push(attrs, function(e){
	  ...
	  createAll: function(list, cb){},
	  find: function(id, cb){
	    this.db.child(this.table).child(id).once('value', function(snapshot){
	      var val;
	      val = snapshot.val();
	      cb(val);
	    });
	  ...
	  findAll: function(cb){
	    ...
	    this.db.once('value', function(snapshot){
	      var val, _val;
	      val = snapshot.val();
	      _val = $.map(val[_this.table], function(value, index){
	        value.id = index;
	        return [value];
	      });
	      if (cb) {
	  ...
	  update: function(id, attrs, cb){
	    this.db.child(this.table).child(id).update(attrs);
	    if (cb) {
	      cb(id);
	    }
	  },
	  updateAll: function(list, cb){},
	  destroy: function(id, cb){
	    this.db.child(this.table).child(id).remove();
	    if (cb) {
	      cb(id);
	    }
	  },
	  ...
	  autoload: function(component, checked){
	    ...
	    if (component.id && checked) {
	      this.db.on('value', func);
	    } else {
	      this.db.off('value', func);
	    }
	  }
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\cloud\store-firebase.ls.map
