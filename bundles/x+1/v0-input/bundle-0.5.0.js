...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(19);
	Datas = {
	  'static': __webpack_require__(20)
	};
	templates = {
	  'default': __webpack_require__(21),
	  alt: __webpack_require__(22)
	};
	samples = {
	  notes: __webpack_require__(23)
	};
	vendors = {
	  highlight_js: __webpack_require__(24),
	  highlight_css: __webpack_require__(25),
	  katex_css: __webpack_require__(26),
	  katex_js: __webpack_require__(27),
	  katex_auto_js: __webpack_require__(28),
	  primer_css: __webpack_require__(29)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputRunJs = function(o){
	    ...
	    this.runs[o.ext]({
	      src: o.src,
	      run: this.runGetValue(),
	      entity: o.entity
	    });
	  };
	  o.outputRunFrameDm = function(o){
	    var scripts, styles, content, frame, js, css;
	    ...
	    js = this.cmdGetIncludesAsTags({
	      includes: scripts,
	      tag: 'script'
	    });
	    css = this.cmdGetIncludesAsTags({
	      includes: styles,
	      tag: 'style'
	    });
	    frame.write(js);
	  ...
	  o.outputMakeTypeContainer = (o)     -> @outputMakeTypeContainerSz o
	  o.outputMakeUrlhashContainer = (o)  -> @outputMakeUrlhashContainerSz o
	  o.outputMakeExtContainer =  (o)     -> @outputMakeExtContainerSz o
	  o.outputMakeEditorContainer = (o)  !-> @outputMakeEditorContainerJq o
	  o.outputMakeIframeContainer = (o)  !-> @outputMakeIframeContainerJq o
	  o.outputSetPropValue = (o)         !-> @outputSetPropValueSz o
	  o.outputGetPropValue = (o)          -> @outputGetPropValueSz o
	  o.outputSetPropEnabled = (o)       !-> @outputSetPropEnabledSz o
	  o.outputSetPropDisabled = (o)      !-> @outputSetPropDisabledSz o
	  
	  o.outputGetIframeContainer = (o)    -> @outputGetIframeContainerJqDm o
	  o.outputQueryIframeEachData = (o)   -> @outputQueryIframeEachDataJq o
	  o.outputGetDefaultHtml = (o)        -> @outputGetDefaultHtmlJs o
	  o.outputGetInput = (o)              -> @outputGetInputJs o
	  
	  o.initOutputJsMore = !->
	    console.log 'Output!'
	    _this = @
	    # 
	    #(require './run/md.ls')   Component
	    #(require './run/html.ls') Component
	    #(require './run/jade.ls') Component
	    #(require './run/js.ls')   Component
	    #(require './run/ls.ls')   Component
	    #(require './run/css.ls')  Component
	    # 
	    @runs =
	      md:    (o) -> _this.outputMd o
	      html:  (o) -> _this.outputHtml o
	      jade:  (o) -> _this.outputJade o
	      js:    (o) -> _this.outputJs o
	      ls:    (o) -> _this.outputLs o
	    # 
	    @output = 
	      type:    @outputMakeTypeContainer    @props.output.type
	      urlhash: @outputMakeUrlhashContainer @props.output.urlhash
	      ext:     @outputMakeExtContainer     @props.output.ext
	    @outputSetPropValue    prop: 'type',    value: 'iframe'
	    @outputSetPropValue    prop: 'urlhash', value: '#/'
	    @outputSetPropDisabled prop: 'ext'
	    
	  o.outputGetIframeContainerJqDm = (o) ->
	    $ '#content__output__iframe' .remove!
	    $ '<iframe id="content__output__iframe"></iframe>' 
	      .appendTo '#content__output__holder'
	    iframeInit = document.getElementById 'content__output__iframe'
	    iframe     = iframeInit.contentDocument || iframeInit.contentWindow.document
	    iframe
	    
	  o.outputQueryIframeEachDataJq = (o) ->
	    list = []
	    $ '#content__output__iframe' .contents! .find o.query .each (i, v) !->
	      data = $ @ .data o.data
	      list.push   data
	    list
	  
	  o.outputGetDefaultHtmlJs = (o) ->
	    '<!DOCTYPE html><html><head><style>' + (o.style || '') + 
	    '</style></head><body>' + (o.content || '') + 
	    '<script>' + (o.script || '') + '</script>' + 
	    '</body></html>'
	    
	  o.outputMakeTypeContainerSz = (o) ->
	    _this = @
	    config  = ->
	      ...
	      onChange:    (value) !-> 
	        ...
	        if value == 'editor'
	          _this.outputMakeEditorContainer!
	          _this.outputSetPropEnabled  prop: 'ext'
	          _this.outputSetPropValue    prop: 'ext', value: 'html'
	          _this.outputSetPropDisabled prop: 'urlhash'
	          
	        else 
	          value = 'iframe'
	          _this.outputMakeIframeContainer!
	          _this.outputSetPropDisabled prop: 'ext'
	          _this.outputSetPropEnabled  prop: 'urlhash'
	      create:      false
	    $ '#' + o.id .selectize (config!) .0 .selectize
	    
	  o.outputMakeUrlhashContainerSz = (o) ->
	    _this = @
	    config  = ->
	      maxItems: 1, valueField: 'value', labelField: 'value', sortField: 'value', searchField: 'value'
	      options:     o.options
	      onChange:    (value) !-> 
	        console.log 'Output:Urlhash:Change', value
	      create:      (value) -> 
	        woHashUrl = value.lastIndexOf '#/', 0 == 0
	        if woHashUrl then value = '#/'
	        value: value, label: value
	    $ '#' + o.id .selectize (config!) .0 .selectize
	    
	  o.outputMakeExtContainerSz = (o) ->
	    _this = @
	    config  = ->
	      maxItems: 1, valueField: 'value', labelField: 'value', sortField: 'value', searchField: 'value'
	      options:     o.options
	      onChange:    (value) !-> 
	        console.log 'Output:Ext:Change', value
	        _this.editorSetMode output: true, ext: value
	      create:      false
	    $ '#' + o.id .selectize (config!) .0 .selectize
	  
	  o.outputMakeEditorContainerJq = (o) ->
	    $ '#content__output__iframe' .remove!
	    $ '<textarea id="content__output__editor"></textarea>' 
	      .appendTo '#content__output__holder'
	    @output.editor = @editorMakeContainer id: 'content__output__editor'
	    @editorSetMode output: true, ext: 'html'
	  
	  o.outputMakeIframeContainerJq = (o) ->
	    @output.editor = null
	    $ '#content__output__holder' .html '
	      <iframe id="content__output__iframe"></iframe>
	    '
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.cmdGetIncludesAsTags = function(o){
	    return this.cmdGetIncludesAsTagsJs(o);
	  };
	  ...
	  o.cmdGetIncludesAsTagsJs = function(o){
	    var entity, tags, i$, ref$, len$;
	    entity = 'notes';
	    tags = '';
	    ...
	    function fn$(el){
	      var file, output;
	      file = this.inputs[entity][el];
	      output = this.runs[file.ext]({
	        src: file.src,
	        run: 'compile'
	      });
	      tags += '<' + o.tag + '>' + output + '</' + o.tag + '>\r\n';
	    }
	  };
