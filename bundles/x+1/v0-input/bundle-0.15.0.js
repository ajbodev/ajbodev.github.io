...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.treeDataMakeContainerJt = function(o){
	    var cb;
	    console.log('Tree:Data:Make:Container', o);
	    cb = function(list){
	      var tree;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listDataMakeCreatable = function(o){
	    this.listDataMakeCreatableJq(o);
	  };
	  o.listDataMakeDestroyable = function(o){
	    this.listDataMakeDestroyableJq(o);
	  };
	  o.listDataMakeUpdatable = function(o){
	    this.listDataMakeUpdatableJq(o);
	  };
	  o.listDataMakeMassCheckable = function(o){
	    this.listDataMakeMassCheckableJq(o);
	  };
	  ...
	  o.listDataFormatRowsJs = function(o){
	    ...
	    function fn$(i, item){
	      var row;
	      row = [
	        '<input type="checkbox" data-id="' + item.id + '">', '<a onclick="app.component.routerSetById(\'' + item.id + '\')">' + item.id + '</a>', this.listDataFormatRow({
	          id: item.id,
	          val: item.title || '',
	          attr: 'title'
