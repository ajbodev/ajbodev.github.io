...
/***/ function(module, exports, __webpack_require__) {
	...
	props = __webpack_require__(42);
	Stores = {
	  'static': __webpack_require__(43),
	  indexeddb: __webpack_require__(44),
	  firebase: __webpack_require__(46)
	};
	templates = {
	  layout: {
	    split: __webpack_require__(47),
	    split_vtab: __webpack_require__(48)
	  },
	  app: {
	  ...
	  admin: {
	    inputs: {
	      list_data: __webpack_require__(50)
	    }
	  }
	};
	samples = {
	  input_notes: __webpack_require__(51)
	};
	vendors = {
	  highlight_js: __webpack_require__(52),
	  highlight_css: __webpack_require__(53),
	  katex_css: __webpack_require__(54),
	  katex_js: __webpack_require__(55),
	  katex_auto_js: __webpack_require__(56),
	  primer_css: __webpack_require__(57)
	};
	...
	Component = function(Component){
	  ...
	  o.initFormatJs = function(){
	    ...
	    this.formatSetValue({
	      context: 'inputs',
	      entity: 'notes',
	      value: this.props.formats.inputs.notes.options[0].value
	    });
	    this.formats.datas.main = this.formatMakeContainer(this.props.formats.datas.main);
	    this.formatSetValue({
	      context: 'datas',
	      entity: 'main',
	      value: this.props.formats.datas.main.options[0].value
	    });
	  };
	  ...
	  formats: {
	    ...
	    datas: {
	      main: {
	        context: 'datas',
	        entity: 'main',
	        id: 'content__data__main__format',
	        options: [
	          {
	            value: 'json'
	          }, {
	  ...
	  utils:
	    notes: 
	      export: 
	        ...
	        options: [{name: 'file'},  {name: 'zip'}, {name: 'json'}]
	      import: 
	        input:   'notes'
	        id:      'content__inputs__notes__import'
	        options: [{name: 'file'},  {name: 'json'}]
	    output: 
	      export: 
	        output:  'output'
	        id:      'content__main__output__export'
	        options: [{name: 'html'},  {name: 'zip'},  {name: 'json'}]
	      import: 
	        output:  'output'
...
/***/ function(module, exports) {
	...
	module.exports = "{\n  \"index\":  {\"src\": \"Hi\", \"name\":\"index\",  \"ext\":\"++.md\", \"mode\":\"text/x-markdown\"},\n  \"config\": {\"src\": \"{}\", \"name\":\"config\", \"ext\":\"json\",  \"mode\":\"text/application/x-json\"}\n}";
