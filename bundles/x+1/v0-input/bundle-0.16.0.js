...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component, props, Datas, templates, samples, vendors, component;
	Component = __webpack_require__(1);
	props = __webpack_require__(32);
	Datas = {
	  'static': __webpack_require__(33),
	  dexie: __webpack_require__(34)
	};
	templates = {
	  layout: {
	    'default': __webpack_require__(36),
	    alt: __webpack_require__(37)
	  }
	};
	samples = {
	  input_notes: __webpack_require__(38)
	};
	vendors = {
	  highlight_js: __webpack_require__(39),
	  highlight_css: __webpack_require__(40),
	  katex_css: __webpack_require__(41),
	  katex_js: __webpack_require__(42),
	  katex_auto_js: __webpack_require__(43),
	  primer_css: __webpack_require__(44)
	};
	...
	component.init();
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\index\jquery\index.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.prototype = {
	  ...
	  initModules: function(){
	    ...
	    __webpack_require__(4)(Component);
	    __webpack_require__(5)(Component);
	    __webpack_require__(6)(Component);
	    __webpack_require__(7)(Component);
	    __webpack_require__(8)(Component);
	    __webpack_require__(9)(Component);
	    __webpack_require__(10)(Component);
	    __webpack_require__(11)(Component);
	    __webpack_require__(12)(Component);
	    __webpack_require__(13)(Component);
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.configDefault = function(o){
	    this.configDefaultJs(o);
	  };
	  ...
	  o.configReset = function(o){
	    this.configResetJs(o);
	  };
	  o.configSet = function(o){
	    this.configSetJs(o);
	  };
	  o.configSetLayout = function(o){
	    this.configSetLayoutJq(o);
	  };
	  o.configSetData = function(o){
	    this.configSetDataJs(o);
	  };
	  o.initConfigJs = function(){
	    ...
	    this.configLoad();
	    this.configSave();
	    this.configSetLayout();
	    this.configSetData();
	  };
	  o.configDefaultJs = function(o){
	  ...
	  o.configSet = function(o){
	    ...
	    context = o.context;
	    prop = o.prop;
	    this.config[context] = prop;
	  };
	  o.configSetLayoutJq = function(o){
	    var layout;
	    console.log('Config:Set:Layout');
	    layout = this.config.layout;
	    $('#app').html(this.templates.layout[layout]);
	  };
	  o.configSetDataJs = function(o){
	    var adapter, params;
	    console.log('Config:Set:Data');
	    adapter = this.config.data.index;
	    params = this.config.data[adapter];
	    this.data = new this.Datas[adapter](params);
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\boot\config.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initOptionData = function(){
	    this.initOptionDataIcJq();
	  };
	  o.initOptionVendor = function(){
	    this.initOptionVendorIcJq();
	  };
	  o.optionDataSet = function(o){
	    this.optionDataSetJs(o);
	  };
	  o.optionVendorLoadScript = function(o){
	    this.optionVendorLoadScriptDmJq(o);
	  };
	  o.initOptionJs = function(){
	    ...
	    _this = this;
	    this.initOptionData();
	    this.initOptionVendor();
	    this.optionDataSet({
	      data: this.config.data.index
	    });
	  };
	  o.initOptionDataIcJq = function(){
	    var _this;
	    _this = this;
	    $('#content__option__data__static').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('#content__option__data__dexie').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('#content__option__data__lowdb').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('#content__option__data__ajax').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('#content__option__data__scriptform').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('#content__option__data__firebase').iCheck({
	      radioClass: 'iradio_minimal-red'
	    });
	    $('input[name="content__option__data"]').on('ifChecked', function(el, i){
	      var data, prop;
	      data = this.value;
	      prop = $('#content__option__data__' + data + '__url').val() || {
	        db: 'x_1',
	        table: 'data'
	      };
	      _this.config.data.index = data;
	      _this.config.data[data] = prop;
	      _this.configSave();
	      console.log(data);
	    });
	  };
	  o.initOptionVendorIcJq = function(){
	    var _this;
	    _this = this;
	    $('#content__option__run__babel').iCheck({
	      checkboxClass: 'icheckbox_minimal-red'
	    });
	    $('#content__option__run__ts').iCheck({
	      checkboxClass: 'icheckbox_minimal-red'
	    });
	    $('#content__option__run__babel').on('ifChecked', function(){
	      _this.optionVendorLoadScript({
	        id: 'babel'
	      });
	    });
	    $('#content__option__run__ts').on('ifChecked', function(){
	      _this.optionVendorLoadScript({
	        id: 'ts'
	      });
	    });
	  };
	  o.optionDataSetJs = function(o){
	    $('#content__option__data__' + o.data).iCheck('check');
	  };
	  o.optionVendorLoadScriptDmJq = function(o){
	    var script;
	    script = document.createElement('script');
	    script.src = $('#content__option__run__' + o.id + '__src').val();
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\boot\option.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.layoutMakeContainer = function(o){
	    return this.layoutMakeContainerSz(o);
	  };
	  ...
	  o.initLayoutJs = function(){
	    console.log('layout!');
	    this.layout = this.layoutMakeContainer(this.props.layout);
	    this.layoutSetValue({
	      value: this.props.layout.options[0].value
	    });
	  };
	  o.layoutMakeContainerSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\boot\layout.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.editorToggleLintJqCm = function(o){
	    var state;
	    state = $('#' + o.lintId).prop('checked');
	    this.editors[o.context][o.entity].setOption('lint', state);
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\editor.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\file.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\ext.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.modeSetValueSz = function(o){
	    this.modes[o.context][o.entity].setValue(o.value, function(){});
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\mode.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runMakeContainer = function(o){
	    return this.runMakeContainerSz(o);
	  };
	  o.runSetValue = function(o){
	    this.runSetValueSz(o);
	  };
	  o.runGetValue = function(o){
	    return this.runGetValueSz(o);
	  };
	  ...
	  o.runMakeContainerSz = function(o){
	    var _this, config;
	    _this = this;
	    config = function(){
	      return {
	  ...
	  o.runSetValueSz = function(o){
	    this.run.setValue(o.value, function(){});
	  };
	  o.runGetValueSz = function(o){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.frameQueryEachData = function(o){
	    return this.frameQueryEachDataJq(o);
	  };
	  ...
	  o.frameQueryEachDataJq = function(o){
	    var list;
	    list = [];
	    $('#content__output__index__frame').contents().find(o.query).each(function(i, v){
	      var data;
	      data = $(this).data(o.data);
	      list.push(data);
	    });
	    return list;
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\frame.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.urlhashSetValueSz = function(o){
	    this.urlhash.setValue(o.value, function(){});
	  };
	  o.urlhashGetValueSz = function(o){
	    return this.urlhash.getValue();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\urlhash.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputRefresh = function(o){
	    this.inputRefreshJs(o);
	  };
	  ...
	  o.inputLoadAuto = function(o){
	    this.inputLoadAuto(o);
	  };
	  o.initInputJs = function(){
	    console.log('Input!');
	    this.inputMakeContainer({
	      entity: 'notes',
	      editor: this.props.editors.inputs.notes,
	      file: this.props.files.inputs.notes,
	      ext: this.props.exts.inputs.notes,
	      mode: this.props.modes.inputs.notes
	    });
	    this.inputReset({
	      entity: 'notes'
	    });
	  ...
	  o.inputGetJs = function(o){
	    ...
	    return this.inputs[o.entity][this.input[o.entity]];
	  };
	  ...
	  o.inputCreateJs = function(o){
	    ...
	    console.log(o.entity, o.file, o.src, o.ext, o.mode);
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\input.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputRun = function(o){
	    return this.outputRunJs(o);
	  };
	  o.outputRunFrame = function(o){
	    this.outputRunFrameDmJq(o);
	  };
	  o.outputRunEditor = function(o){
	    this.outputRunEditorJs(o);
	  };
	  o.outputMakeContainer = function(o){
	    this.outputMakeContainerJs(o);
	  };
	  o.outputMakeContainerFrame = function(o){
	    this.outputMakeContainerFrameJq(o);
	  };
	  o.outputMakeContainerEditor = function(o){
	    this.outputMakeContainerEditorJq(o);
	  };
	  o.outputOnRunChange = function(o){
	    this.outputOnRunChangeJs(o);
	  };
	  ...
	  o.initOutputJs = function(){
	    ...
	    console.log('Output!');
	    _this = this;
	    this.run = this.runMakeContainer(this.props.run);
	    this.runSetValue({
	      value: 'frame'
	    });
	    this.exts.outputs.index = this.extMakeContainer(this.props.exts.outputs.index);
	    this.extSetValue({
	      context: 'outputs',
	      entity: 'index',
	      value: 'html'
	    });
	    this.modes.outputs.index = this.modeMakeContainer(this.props.modes.outputs.index);
	    this.modeSetValue({
	      context: 'outputs',
	      entity: 'index',
	      value: 'text/html'
	    ...
	    __webpack_require__(14)(Component);
	    __webpack_require__(15)(Component);
	    __webpack_require__(16)(Component);
	    __webpack_require__(17)(Component);
	    __webpack_require__(18)(Component);
	    __webpack_require__(19)(Component);
	    __webpack_require__(20)(Component);
	    __webpack_require__(21)(Component);
	    this.runs = {
	      'html': function(o){
	        return _this.runHtml(o);
	      },
	      'jade': function(o){
	        return _this.runJade(o);
	      },
	      'md': function(o){
	        return _this.runMd(o);
	      },
	      'js': function(o){
	        return _this.runJs(o);
	      },
	      'ls': function(o){
	        return _this.runLs(o);
	      },
	      'ts': function(o){
	        return _this.runTs(o);
	      },
	      'babel.js': function(o){
	        return _this.runBabel(o);
	      },
	      'css': function(o){
	        return _this.runCss(o);
	      }
	    };
	  };
	  o.outputRunJs = function(o){
	    ...
	    console.log('Output:Run:Pre');
	    src = '';
	    config = this.cmdGetConfig();
	    if (config.includes) {
	      src += this.cmdGetIncludes({
	        includes: config.includes,
	        format: 'text'
	      });
	    }
	    src += o.src;
	    return this.runs[o.ext]({
	      src: src,
	      run: o.run || this.runGetValue()
	    });
	  };
	  o.outputRunFrameDmJq = function(o){
	    var _this, scripts, styles, css, js, content, frame;
	    ...
	    css = '';
	    js = '';
	    content = o.src || this.frameBuildMarkup({
	      content: o.content || '',
	      script: o.script || '',
	      style: o.style || ''
	    });
	    ...
	    frame.open();
	    frame.write(content);
	    scripts = this.frameQueryEachData({
	      query: 'script[data-include]',
	      data: 'include'
	    });
	    styles = this.frameQueryEachData({
	      query: 'style[data-include]',
	      data: 'include'
	    });
	    css = this.cmdGetIncludes({
	      includes: styles,
	      format: 'markup',
	      tag: 'style'
	    });
	    js = this.cmdGetIncludes({
	      includes: scripts,
	      format: 'markup',
	      tag: 'script'
	    });
	    $('#content__output__index__frame').contents().find('div[data-include]').each(function(e, v){
	      var include, file;
	      include = $(this).data('include') + '';
	      file = _this.inputs['notes'][include];
	      v.innerHTML = _this.runs[file.ext]({
	        src: file.src,
	        run: 'compile'
	      });
	    });
	  ...
	  o.outputGetConfigIncludesJs = function(o){};
	  ...
	  o.outputMakeContainerFrameJq = function(o){
	    $('#content__output__index__button__holder').html('<button type="button" id="content__output__index__urlhash__button" class="btn btn-default"><i class="fa fa-hashtag"></i></button>');
	    $('#content__output__index__select__holder').html('<select id="content__output__index__urlhash"></select>');
	    $('#content__output__index__holder').html('<iframe id="content__output__index__frame"></iframe>');
	  ...
	  o.outputMakeContainerEditorJq = function(o){
	    $('#content__output__index__button__holder').html('<button id="content__output__index__file__destroy" type="button" class="btn btn-danger disabled"><i class="fa fa-trash"></i></button>');
	    $('#content__output__index__select__holder').html('<select id="content__output__index__file"></select>');
	    $('#content__output__index__holder').html('<textarea id="content__output__index__editor"></textarea>');
	  ...
	  o.outputOnRunChangeJs = function(o){
	    var _this, run;
	  ...
	  o.outputSetPropValueSz = (o) !->
	    @output[o.prop].setValue o.value, ->
	  
	  o.outputGetPropValueSz = (o) ->
	    @output[o.prop].getValue!
	  
	  o.outputSetPropEnabledSz = (o) ->
	    @output[o.prop].enable!
	  
	  o.outputSetPropDisabledSz = (o) ->
	    @output[o.prop].disable!
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\output.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.runHtml = function(o){
	    return this.runHtmlJs(o);
	  };
	  o.runHtmlFrame = function(o){
	    this.runHtmlFrameJs(o);
	  };
	  o.runHtmlEditor = function(o){
	    this.runHtmlEditorJs(o);
	  };
	  o.runHtmlCompile = function(o){
	    return this.runHtmlCompileJs(o);
	  };
	  o.runHtmlJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runHtmlFrameJs = function(o){
	    console.log('Run:Html:Frame');
	    this.outputRunFrame({
	      src: o.src
	    });
	  };
	  o.runHtmlEditorJs = function(o){
	    console.log('Run:Html:Editor');
	    this.outputRunEditor({
	      src: o.src
	    });
	  };
	  o.runHtmlCompileJs = function(o){
	    console.log('Run:Html:Compile');
	    return o.src;
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\html.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.runJade = function(o){
	    return this.runJadeJs(o);
	  };
	  o.runJadeFrame = function(o){
	    this.runJadeFrameJs(o);
	  };
	  o.runJadeEditor = function(o){
	    this.runJadeEditorJs(o);
	  };
	  o.runJadeCompile = function(o){
	    return this.runJadeCompileJd(o);
	  };
	  o.runJadeJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runJadeFrameJs = function(o){
	    console.log('Run:Jade:Frame');
	    this.outputRunFrame({
	      src: this.runJadeCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runJadeEditorJs = function(o){
	    console.log('Run:Jade:Editor');
	    this.outputRunEditor({
	      src: this.runJadeCompile({
	        src: o.src
	      })
	  ...
	  o.runJadeCompileJd = function(o){
	    console.log('Run:Jade:Compile');
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\jade.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o = Component.prototype;
	  o.runMd = function(o){
	    return this.runMdJs(o);
	  };
	  o.runMdFrame = function(o){
	    this.runMdFrameJs(o);
	  };
	  o.runMdEditor = function(o){
	    this.runMdEditorJs(o);
	  };
	  o.runMdCompile = function(o){
	    return this.runMdCompileMd(o);
	  };
	  o.runMdJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runMdFrameJs = function(o){
	    console.log('Run:Md:Frame');
	    this.outputRunFrame({
	      content: this.runMdCompile({
	        src: o.src
	      }),
	      style: this.vendors.primer_css + '\n' + this.vendors.highlight_css + '\n' + this.vendors.katex_css + '\n' + 'body { font-size: 16px; }',
	      script: this.vendors.highlight_js + '\n' + 'setTimeout(function(){var _code, i$, len$, j, i;_code = document.getElementsByTagName("pre");for (i$ = 0, len$ = _code.length; i$ < len$; ++i$) {j = i$;i = _code[i$];hljs.highlightBlock(i);}}, 0);' + this.vendors.katex_js + '\n' + this.vendors.katex_auto_js + '\n' + ';renderMathInElement(document.body);' + '\n'
	    });
	  };
	  o.runMdEditorJs = function(o){
	    console.log('Run:Md:Editor');
	    this.outputRunEditor({
	      src: this.runMdCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runMdCompileMd = function(o){
	    console.log('Run:Md:Compile');
	    return marked(o.src);
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\md.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o = Component.prototype;
	  o.runJs = function(o){
	    return this.runJsJs(o);
	  };
	  o.runJsFrame = function(o){
	    this.runJsFrameJs(o);
	  };
	  o.runJsEditor = function(o){
	    this.runJsEditorJs(o);
	  };
	  o.runJsCompile = function(o){
	    return this.runJsCompileJs(o);
	  };
	  o.runJsJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runJsFrameJs = function(o){
	    console.log('Run:Js:Frame');
	    this.outputRunFrame({
	      script: o.src
	    });
	  };
	  o.runJsEditorJs = function(o){
	    console.log('Run:Js:Editor');
	    this.outputRunEditor({
	      src: o.src
	    });
	  };
	  o.runJsCompileJs = function(o){
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\js.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o = Component.prototype;
	  o.runLs = function(o){
	    return this.runLsJs(o);
	  };
	  o.runLsFrame = function(o){
	    this.runLsFrameJs(o);
	  };
	  o.runLsEditor = function(o){
	    this.runLsEditorJs(o);
	  };
	  o.runLsCompile = function(o){
	    return this.runLsCompileLs(o);
	  };
	  o.runLsJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runLsFrameJs = function(o){
	    console.log('Run:Ls:Frame');
	    this.outputRunFrame({
	      script: this.runLsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runLsEditorJs = function(o){
	    console.log('Run:Ls:Editor');
	    this.outputRunEditor({
	      src: this.runLsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runLsCompileLs = function(o){
	    console.log('Run:Ls:Compile');
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\ls.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o = Component.prototype;
	  o.runTs = function(o){
	    return this.runTsJs(o);
	  };
	  o.runTsFrame = function(o){
	    this.runTsFrameJs(o);
	  };
	  o.runTsEditor = function(o){
	    this.runTsEditorJs(o);
	  };
	  o.runTsCompile = function(o){
	    return this.runTsCompileTs(o);
	  };
	  o.runTsJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runTsFrameJs = function(o){
	    console.log('Run:Ts:Frame');
	    this.outputRunFrame({
	      script: this.runTsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTsEditorJs = function(o){
	    console.log('Run:Ts:Editor');
	    this.outputRunEditor({
	      src: this.runTsCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runTsCompileTs = function(o){
	    console.log('Run:Ts:Compile');
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\ts.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.runBabel = function(o){
	    return this.runBabelJs(o);
	  };
	  o.runBabelFrame = function(o){
	    this.runBabelFrameJs(o);
	  };
	  o.runBabelEditor = function(o){
	    this.runBabelEditorJs(o);
	  };
	  o.runBabelCompile = function(o){
	    return this.runBabelCompileBb(o);
	  };
	  o.runBabelJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	      ...
	      editor: function(){
	        _this.runBabelEditor({
	          src: o.src
	        });
	      },
	      compile: function(){
	        return _this.runBabelCompile({
	          src: o.src
	        });
	      }
	    };
	  ...
	  o.runBabelFrameJs = function(o){
	    console.log('Run:Babel:Frame');
	    this.outputRunFrame({
	      script: this.runBabelCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runBabelEditorJs = function(o){
	    console.log('Run:Babel:Editor');
	    this.outputRunEditor({
	      src: this.runBabelCompile({
	        src: o.src
	      })
	    });
	  };
	  o.runBabelCompileBb = function(o){
	    console.log('Run:Babel:Compile');
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\babel.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o = Component.prototype;
	  o.runCss = function(o){
	    return this.runCssJs(o);
	  };
	  o.runCssFrame = function(o){
	    this.runCssFrameJs(o);
	  };
	  o.runCssEditor = function(o){
	    this.runCssEditorJs(o);
	  };
	  o.runCssCompile = function(o){
	    return this.runCssCompileJs(o);
	  };
	  o.runCssJs = function(o){
	    var _this, run;
	    _this = this;
	    run = {
	      frame: function(){
	  ...
	  o.runCssFrameJs = function(o){
	    console.log('Run:Css:Frame');
	    this.outputRunFrame({
	      src: o.src
	    });
	  };
	  o.runCssEditorJs = function(o){
	    console.log('Run:Css:Editor');
	    this.outputRunEditor({
	      src: o.src
	    });
	  };
	  o.runCssCompileJs = function(o){
	    console.log('Run:Css:Compile');
	    return o.src;
	  };
	};
	if (true) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\run\css.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.cmdRunNotes = function(o){
	    this.cmdRunNotesJs(o);
	  };
	  o.cmdSaveById = function(o){
	    this.cmdSaveByIdJs(o);
	  };
	  o.cmdLoadById = function(o){
	    this.cmdLoadByIdJs(o);
	  };
	  o.cmdIsAutoSave = function(o){
	    return this.cmdIsAutoSaveJq(o);
	  };
	  o.cmdIsAutoRun = function(o){
	    return this.cmdIsAutoRunJq(o);
	  };
	  o.cmdIsAutoLoad = function(o){
	    return this.cmdIsAutoLoadJq(o);
	  };
	  o.cmdReset = function(o){
	    this.cmdResetJs(o);
	  };
	  o.cmdGetIncludes = function(o){
	    return this.cmdGetIncludesJs(o);
	  };
	  o.cmdGetImports = function(o){
	    return this.cmdGetImportsJs(o);
	  };
	  o.cmdGetConfig = function(o){
	    return this.cmdGetConfigJs(o);
	  };
	  o.initCmdJqIc = function(){
	    var _this;
	    _this = this;
	    console.log('Cmd!');
	    $('#content__cmd__run').click(function(){
	      _this.cmdRun();
	    });
	    $('#content__cmd__save').click(function(){
	      _this.cmdSaveById();
	    });
	    $('#content__cmd__load').click(function(){
	      _this.cmdLoadById();
	    });
	    $('#content__input__notes__run').click(function(){
	      _this.cmdRunNotes();
	    });
	    $('#content__cmd__run__auto').iCheck({
	      checkboxClass: 'icheckbox_minimal-blue'
	    });
	    $('#content__cmd__save__auto').iCheck({
	      checkboxClass: 'icheckbox_minimal-green'
	    });
	    $('#content__cmd__load__auto').iCheck({
	      checkboxClass: 'icheckbox_minimal-orange'
	    });
	    $('#content__cmd__save__auto').iCheck('check');
	  };
	  o.cmdSaveByIdJs = function(o){
	    var _this, id, attrs;
	    console.log('Cmd:Save:By:Id');
	    _this = this;
	    id = this.id;
	    if (id) {
	      attrs = {
	        input_notes: JSON.stringify(this.inputs.notes)
	      };
	      this.dataUpdate({
	        id: id,
	        attrs: attrs
	  ...
	  o.cmdLoadByIdJs = function(o){
	    var _this, id, cb;
	    console.log('Cmd:Load:By:Id');
	    _this = this;
	    id = this.id;
	    if (id) {
	      cb = function(attrs){
	  ...
	  o.cmdIsAutoSaveJq = function(o){
	    console.log('Cmd:Is:Auto:Save');
	    return $('#content__cmd__save__auto').prop('checked');
	  };
	  o.cmdIsAutoRunJq = function(o){
	    console.log('Cmd:Is:Auto:Run');
	    return $('#content__cmd__run__auto').prop('checked');
	  };
	  o.cmdResetJs = function(o){
	    console.log('Cmd:Reset');
	    this.inputReset({
	      entity: 'notes'
	    });
	  };
	  o.cmdRunNotesJs = function(o){
	    console.log('Cmd:Run:Notes');
	    this.outputRun(this.inputGet({
	      entity: 'notes'
	    }));
	  };
	  o.cmdGetIncludesJs = function(o){
	    var entity, str, i$, ref$, len$;
	    entity = 'notes';
	    str = '';
	    for (i$ = 0, len$ = (ref$ = o.includes).length; i$ < len$; ++i$) {
	      (fn$.call(this, ref$[i$]));
	    }
	    return str;
	    function fn$(el){
	      ...
	      if (o.format === 'markup') {
	        ...
	        str += '<' + o.tag + '>' + output + '</' + o.tag + '>\r\n';
	      } else if (o.format === 'text') {
	        str += file.src + '\r\n';
	      }
	    }
	  };
	  o.cmdGetConfigJs = function(o){
	    var entity, params, index, config;
	    entity = 'notes';
	    params = {};
	    index = this.inputGet({
	      entity: entity
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\main\cmd.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.settingSetLg = function(o){
	    ...
	    localStorage.setItem('settings', JSON.stringify(o.settings));
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\store\setting.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.dataCreateMm = function(o){
	    ...
	    for (i$ in ref$ = this.samples) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    this.data.create(attrs, o.cb);
	    function fn$(i, el){
	      attrs[i] = el;
	    }
	  };
	  o.dataUpdateJs = function(o){
	    ...
	    this.data.update(o.id, o.attrs, o.cb);
	  };
	  o.dataFindJs = function(o){
	    console.log('Data:Find');
	    this.data.find(o.id, o.cb);
	  };
	  o.dataFindAllJs = function(o){
	    console.log('Data:Find:All');
	    this.data.findAll(o.cb);
	  };
	  o.dataDestroyJs = function(o){
	    console.log('Data:Destroy');
	    this.data.destroy(o.id, o.cb);
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\store\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\route.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.srcDataFormatRows = function(o){
	    return this.srcDataFormatRowsJs(o);
	  };
	  o.srcDataGetColumns = function(o){
	    return this.srcDataGetColumnsJs(o);
	  };
	  o.srcDataMakeUpdatable = function(o){
	    return this.srcActionJs(o);
	  };
	  o.srcDataMakeCreatable = function(o){
	    return this.srcActionJs(o);
	  };
	  o.srcDataMakeDestroyable = function(o){
	    return this.srcActionJs(o);
	  };
	  o.srcDataCreate;
	  ...
	  o.srcActionJs = function(o){
	    return console.log('Src:Action');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\src.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.treeMakeContainer = function(o){
	    this.treeMakeContainerDa(o);
	  };
	  o.treeMakeEditable = function(o){
	    this.treeMakeEditableJq(o);
	  };
	  o.treeMakeCheckall = function(o){
	    this.treeMakeCheckallJq(o);
	  };
	  o.treeRefresh = function(o){
	    this.treeRefreshJs(o);
	  };
	  o.initTreeJs = function(){
	    console.log('Tree!');
	    __webpack_require__(28)(Component);
	    this.treeDataMakeContainer(this.props.trees.data);
	  };
	  o.treeMakeContainerDa = function(o){
	    return console.log('Tree:Make:Container');
	  };
	  o.treeMakeEditableJq = function(o){
	    return console.log('Tree:Make:Editable');
	  };
	  o.treeMakeCheckallJq = function(o){
	    return console.log('Tree:Make:Checkall');
	  };
	  o.treeRefreshJq = function(o){
	    return console.log('Tree:Refresh');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\tree.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.treeDataMakeEditable = function(o){
	    this.treeDataMakeEditableJq(o);
	  };
	  o.treeDataMakeCheckall = function(o){
	    this.treeDataMakeCheckallJq(o);
	  };
	  o.treeDataRefresh = function(o){
	    this.treeDataRefreshJs(o);
	  };
	  o.treeDataMakeContainerJt = function(o){
	    var cb;
	    console.log('Tree:Data:Make:Container');
	    cb = function(list){
	      var tree;
	      tree = $('#content__tree__data').jstree();
	      /*
	      items = []
	      for let item, i in list
	        _item = {}
	        if item.tree
	          _text_index   = item.tree.lastIndexOf '/'
	          _item.id      = 'content__tree__data_' + item.tree
	          _item.data    = item.tree
	          _item.text    = if _text_index > 0 then (item.tree.substr _text_index + 1, item.tree.length) else item.tree
	          _item.li_attr = data_id: item.id
	          _item.parent  = if _text_index > 0 then ('content__tree__data_' + item.tree.substr 0, _text_index) else '#'
	          items.push _item
	      #$ '#content__tree' .html '<div id="content__tree"></div>'
	      #$ '#' + o.id .jstree true .settings .core .data = items
	      */
	      $('#content__tree__data').jstree().settings.core.data = [
	        {
	          id: 'content__tree__data_1',
	          data: 'asd',
	          text: 'asd',
	          parent: '#'
	        }, {
	          id: 'content__tree__data_2',
	          data: 'vvv',
	          text: 'vvv',
	          parent: '#'
	        }
	      ];
	      $('#content__tree__data').jstree().refresh();
	    };
	    return this.dataFindAll({
	      cb: cb
	    });
	  };
	  o.treeDataMakeEditableJq = function(o){
	    return console.log('Tree:Data:Make:Editable');
	  };
	  o.treeDataMakeCheckallJq = function(o){
	    return console.log('Tree:Data:Make:Checkall');
	  };
	  o.treeDataRefreshJq = function(o){
	    return console.log('Tree:Data:Refresh');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\tree\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listMakeContainer = function(o){
	    this.listMakeContainerDa(o);
	  };
	  o.listMakeEditable = function(o){
	    this.listMakeEditableJq(o);
	  };
	  o.listMakeCreatable = function(o){
	    this.listMakeCheckallJq(o);
	  };
	  o.listMakeDestroyable = function(o){
	    this.listMakeCheckallJq(o);
	  };
	  o.listMakeCheckall = function(o){
	    this.listMakeCheckallJq(o);
	  };
	  o.listRefresh = function(o){
	    this.listRefreshJs(o);
	  };
	  o.initListJs = function(){
	    console.log('List!');
	    __webpack_require__(30)(Component);
	    __webpack_require__(31)(Component);
	    this.listDataMakeContainer(this.props.lists.data);
	    this.listInputMakeContainer(this.props.lists.input);
	  };
	  o.listMakeContainerDa = function(o){
	    console.log('List:Make:Container');
	    this.dataFindAll(cb);
	  };
	  o.listMakeEditableJq = function(o){
	    return console.log('List:Make:Editable');
	  };
	  o.listMakeCheckallJq = function(o){
	    return console.log('List:Make:Checkall');
	  };
	  o.listRefreshJq = function(o){
	    return console.log('List:Refresh');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\list.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.listDataMakeCreatable = function(o){
	    this.listDataMakeCreatableJqMm(o);
	  };
	  o.listDataMakeDestroyable = function(o){
	    this.listDataMakeDestroyableJq(o);
	  };
	  ...
	  o.listDataMakeContainerDt = function(o){
	    var _this, cb;
	    console.log('List:Data:Make:Container');
	    _this = this;
	    cb = function(list){
	      var table;
	      table = {
	      ...
	      _this.lists[o.name] = $('#' + o.id).DataTable(table);
	    };
	    if (o.creatable) {
	      _this[o.creatable]();
	    }
	  ...
	  o.listDataFormatRowsJs = function(o){
	    var rows, i$, ref$, len$;
	    console.log('List:Data:Format:Rows');
	    rows = [];
	    ...
	    function fn$(i, item){
	      var row;
	      row = [
	        '<input type="checkbox" data-id="' + item.id + '">', '<a onclick="app.component.routeSetById({id: \'' + item.id + '\'})">' + item.id + '</a>', this.listDataFormatRow({
	          id: item.id,
	          val: item.title || '',
	          attr: 'title'
	  ...
	  o.listDataMakeHolderJq = function(o){
	    $('#content__list__data_wrapper').html('<table id="content__list__data" class="table table-bordered table-hover"></table>');
	  };
	  o.listDataClearInputsJq = function(o){
	    $('#content__list__data__inputs input[type="text"]').each(function(){
	      $(this).val('');
	    });
	  };
	  o.listDataRefreshJs = function(o){
	    console.log('List:Refresh');
	    this.listDataClearInputs();
	    this.listDataMakeHolder();
	    this.listDataMakeContainer({
	      id: 'content__list__data',
	      name: 'data',
	      editable: 'listDataMakeEditable',
	      checkallable: 'listDataMakeCheckallable'
	    });
	  };
	  o.listDataMakeCreatableJqMm = function(o){
	    var _this;
	    console.log('List:Data:Make:Creatable');
	    _this = this;
	    $('#content__list__data__create').click(function(){
	      var attrs, cb;
	      attrs = {
	        date: moment().format('DD/MM/YYYY')
	      };
	  ...
	  o.listDataMakeDestroyableJq = function(o){
	    console.log('List:Data:Make:Destroyable');
	    $('#content__list__data__delete').click(function(){
	      $('#content__list__data tbody tr input:checked').each(function(key, val){
	        var id, cb;
	  ...
	  o.listDataMakeEditableJq = function(o){
	    var _this;
	    console.log('List:Data:Make:Editable');
	    _this = this;
	    $('#content__list__data').on('click', 'tbody tr :not(:first-child):not(:nth-child(2))', function(e){
	      var td, val, id, attr;
	      td = $(this);
	  ...
	  o.listDataMakeCheckallableJq = function(o){
	    console.log('List:Data:Make:Checkallable');
	    $('#content__list__data').on('change', 'thead tr th input[type="checkbox"]:first-child', function(){
	      if ($(this).is(':checked')) {
	        $('#content__list__data tbody tr input:first-child').each(function(){
	  ...
	  o.listDataMakeRefreshableJq = function(o){
	    var _this;
	    console.log('List:Data:Make:Refreshable');
	    _this = this;
	    $('#content__list__data__refresh').click(function(){
	      _this.listDataRefresh();
	    });
	  };
	  o.listDataMakeSearchableJq = function(o){
	    var _this;
	    console.log('List:Data:Make:Searchable');
	    _this = this;
	    $('#content__list__data__title').on('keyup', function(){
	      _this.lists.data.column(2).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__tree').on('keyup', function(){
	      _this.lists.data.column(3).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__labels').on('keyup', function(){
	      _this.lists.data.column(4).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__status').on('keyup', function(){
	      _this.lists.data.column(5).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__date').on('keyup', function(){
	      _this.lists.data.column(6).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__date_start').on('keyup', function(){
	      _this.lists.data.column(7).search(this.value, {
	        regex: true
	      }).draw();
	    });
	    $('#content__list__data__date_end').on('keyup', function(){
	      _this.lists.data.column(8).search(this.value, {
	        regex: true
	      }).draw();
	    });
	  };
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\list\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  var o;
	  o = Component.prototype;
	  o.listInputMakeContainer = function(o){
	    this.listInputMakeContainerDa(o);
	  };
	  o.listInputMakeEditable = function(o){
	    this.listInputMakeEditableJq(o);
	  };
	  o.listInputMakeCreatable = function(o){
	    this.listInputMakeCheckallJq(o);
	  };
	  o.listInputMakeDestroyable = function(o){
	    this.listInputMakeCheckallJq(o);
	  };
	  o.listInputMakeCheckall = function(o){
	    this.listInputMakeCheckallJq(o);
	  };
	  o.listInputRefresh = function(o){
	    this.listInputRefreshJs(o);
	  };
	  o.listInputMakeContainerDa = function(o){
	    var list, formatter, columns, table;
	    console.log('List:Input:Make:Container');
	    list = this.inputFindAll({
	      entity: o.entity
	    });
	    formatter = function(list){
	      var formatted, makeSpan, i$;
	      formatted = [];
	      makeSpan = function(name, val, attr){
	        return '<span data-name="' + name + '" data-attr="' + attr + '">' + val + '</span>' || '';
	      };
	      for (i$ in list) {
	      ...
	      return formatted;
	      function fn$(i, item){
	        formatted.push(['<input type="checkbox" data-name="' + item.name + '">', makeSpan(item.name, item.name || '', 'name'), makeSpan(item.name, item.ext || '', 'ext'), makeSpan(item.name, item.mode || '', 'mode')]);
	      }
	    };
	    columns = [
	      {
	    ...
	    this.lists[o.name] = $('#' + o.id).DataTable(table);
	  };
	  o.listInputMakeEditableJq = function(o){
	    return console.log('List:Input:Make:Editable');
	  };
	  o.listInputMakeCheckallJq = function(o){
	    return console.log('List:Input:Make:Checkall');
	  };
	  o.listInputRefreshJq = function(o){
	    return console.log('List:Input:Refresh');
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\component\jquery\lib\component\admin\list\input.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var props;
	props = {
	  _title: 'rcx-frontend-html-css-js',
	  layout: {
	  ...
	  urlhash: {
	    outputs: {
	      index: {
	        context: 'outputs',
	        entity: 'index',
	        id: 'content__others__notes__mode',
	        options: [{
	          value: '#/'
	        }],
	        onChange: 'outputOnUrlhashChange',
	  ...
	  utils: {
	    notes: {
	      'export': {
	        input: 'notes',
	        id: 'content__inputs__notes__export',
	        options: [
	          {
	            name: 'file'
	          }, {
	      ...
	      'import': {
	        input: 'notes',
	        id: 'content__inputs__notes__import',
	        options: [
	          {
	            name: 'file'
	          }, {
	    ...
	    output: {
	      'export': {
	        output: 'output',
	        id: 'content__main__output__export',
	        options: [
	          {
	            name: 'html'
	          }, {
	      ...
	      'import': {
	        output: 'output',
	        id: 'content__main__output__import',
	        options: [{
	          name: 'json'
	        }]
	      }
	  ...
	  srcs: {
	    list: {
	      ...
	      onChange: 'srcListOnChange'
	    },
	    tree: {
	      id: 'content__list__tree',
	      options: [
	        {
	          value: 'data'
	        }, {
	  ...
	  lists: {
	    data: {
	      id: 'content__list__data',
	      name: 'data',
	      creatable: 'listDataMakeCreatable',
	      destroyable: 'listDataMakeDestroyable',
	      searchable: 'listDataMakeSearchable',
	      refreshable: 'listDataMakeRefreshable',
	      editable: 'listDataMakeEditable',
	      checkallable: 'listDataMakeCheckallable'
	    },
	    input: {
	      id: 'content__list__input',
	      name: 'input',
	      entity: 'notes'
	    }
	  },
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\lib\props\props.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\static\data.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\browser\data-indexeddb-dexie.ls.map
...
/***/ function(module, exports) {
	...
	window.db._version('x_1', 1, {
	  data: db._table.x_1.data[1]
	});
	window.db._init('x_1');
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0-input\store\browser\db-indexeddb-dexie.ls.map
...
/***/ function(module, exports) {
	...
	module.exports = "         <section class=\"content-header\"><h1>&nbsp<i class=\"fa fa-codepen\"></i>&nbspX+1<small>0.16.0-input</small></h1><ol class=\"breadcrumb\"><li><a href=\"#/\" id=\"undefined\"><i class=\"fa fa-codepen\"></i>X+1</a></li><li><a href=\"#/\" id=\"header__data\"><i class=\"fa fa-database\"></i>Static</a></li></ol></section><section class=\"content\"><div class=\"row\"><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__run\" class=\"btn btn-primary\"><i class=\"fa fa-play\"></i></button>&nbsp&nbsp<input id=\"content__cmd__run__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutorun</div><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__save\" class=\"btn btn-success\"><i class=\"fa fa-save\"></i></button>&nbsp&nbsp<input id=\"content__cmd__save__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutosave</div><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__load\" class=\"btn btn-warning\"><i class=\"fa fa-repeat\"></i></button>&nbsp&nbsp<input id=\"content__cmd__load__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutoload</div><div class=\"col-xs-8 col-sm-3 col-md-4\"></div><div class=\"col-xs-4 col-sm-3 col-md-2\"><select id=\"content__layout__select\"></select></div></div><br><div id=\"content__layout\" class=\"row\"><div style=\"padding-right: 7px\" class=\"col-md-6\"><div class=\"nav-tabs-custom\"><ul class=\"nav nav-tabs\"><li class=\"active\"><a href=\"#tab__input__notes\" data-toggle=\"tab\"><i class=\"fa fa-file-text\"></i>&nbsp&nbsp Notes</a></li></ul><div class=\"tab-content\"><div id=\"tab__input__notes\" class=\"tab-pane fade in active\"><div style=\"margin-bottom: 5px;\" class=\"row\"><div class=\"col-md-1\"><button id=\"content__input__notes__run\" type=\"button\" class=\"btn btn-default\"><i class=\"fa fa-play\"></i></button></div><div class=\"col-md-8\"><select id=\"content__input__notes__file\"></select></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__input__notes__ext\"></select></div><div class=\"col-md-1\"><button id=\"content__input__notes__file__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div class=\"row\"><div class=\"col-md-12\"><textarea id=\"content__input__notes__editor\"></textarea></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button type=\"button\" id=\"content__input__notes__export__button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__input__notes__export\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input type=\"file\" id=\"content__input__notes__import__button\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__input__notes__import\"></select></div><div style=\"/*padding: 0;*/\" class=\"col-md-2\"><input type=\"checkbox\" id=\"content__input__notes__lint\" class=\"content__icheck\">&nbsp&nbspLint</div><div class=\"col-md-4\"><select id=\"content__input__notes__mode\"></select></div></div></div></div></div></div><div style=\"padding-left: 7px\" class=\"col-md-6\"><div class=\"nav-tabs-custom\"><ul class=\"nav nav-tabs\"><li class=\"active\"><a href=\"#tab__output\" data-toggle=\"tab\"><i class=\"fa fa-desktop\"></i>&nbsp&nbsp Output</a></li><li><a href=\"#tab__tree\" data-toggle=\"tab\"><i class=\"fa fa-sitemap\"></i>&nbsp&nbsp Tree</a></li><li><a href=\"#tab__list\" data-toggle=\"tab\"><i class=\"fa fa-list\"></i>&nbsp&nbsp List</a></li><li><a href=\"#tab__calendar\" data-toggle=\"tab\"><i class=\"fa fa-calendar\"></i>&nbsp&nbsp Calendar</a></li><li><a href=\"#tab__report\" data-toggle=\"tab\"><i class=\"fa fa-bar-chart\"></i>&nbsp&nbsp Reports</a></li><li><a href=\"#tab__option\" data-toggle=\"tab\"><i class=\"fa fa-list-alt\"></i>&nbsp&nbsp Options</a></li></ul><div class=\"tab-content\"><div id=\"tab__output\" class=\"tab-pane fade in active\"><div style=\"margin-bottom: 5px;\" class=\"row\"><div id=\"content__output__index__button__holder\" class=\"col-md-1\"><button type=\"button\" id=\"content__output__index__urlhash__button\" class=\"btn btn-default\"><i class=\"fa fa-hashtag\"></i></button></div><div id=\"content__output__index__select__holder\" class=\"col-md-7\"><select id=\"content__output__index__urlhash\"></select></div><div style=\"padding-left: 0;\" class=\"col-md-2\"><select id=\"content__output__index__ext\"></select></div><div style=\"padding-left: 0;\" class=\"col-md-2\"><select id=\"content__run\"></select></div></div><div class=\"row\"><div class=\"col-md-12\"><div id=\"content__output__index__holder\"><iframe id=\"content__output__index__frame\"></iframe></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button type=\"button\" id=\"content__output__index__export__button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__output__index__export\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input type=\"file\" id=\"content__output__index__import__button\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__output__index__import\"></select></div><div style=\"/*padding: 0;*/\" class=\"col-md-2\"><input type=\"checkbox\" id=\"content__output__index__lint\" class=\"content__icheck\">&nbsp&nbspLint</div><div class=\"col-md-4\"><select id=\"content__output__index__mode\"></select></div></div></div><div id=\"tab__tree\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__tree__data\" data-toggle=\"tab\">Data</a></li><li><a href=\"#tab__tree__input\" data-toggle=\"tab\">Input</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__tree__data\" class=\"tab-pane fade in active\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__tree__data__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__tree__data__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__tree__data__inputs\" aria-expanded=\"false\" aria-controls=\"content__tree__data__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__tree__data__create\" type=\"button\" disabled class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__tree__data__src\"></select></div><div class=\"col-md-1\"><button id=\"content__tree__data__destroy\" type=\"button\" disabled class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__tree__data__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse\"><br></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__tree__data__holder\"><div id=\"content__tree__data\"></div></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__tree__data__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__data__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__tree__data__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__data__export__type\"></select></div><div class=\"col-md-6\"></div></div></div><div id=\"tab__tree__input\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__tree__input__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__tree__input__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__tree__input__inputs\" aria-expanded=\"false\" aria-controls=\"content__tree__input__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__tree__input__create\" type=\"button\" disabled class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__tree__input__src\"></select></div><div class=\"col-md-1\"><button id=\"content__tree__input__destroy\" type=\"button\" disabled class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__tree__input__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse\"><br></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__tree__input__holder\"><div id=\"content__tree__input\"></div></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__tree__input__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__input__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__tree__input__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__input__export__type\"></select></div><div class=\"col-md-6\"></div></div></div></div></div></div></div><div id=\"tab__list\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__list__data\" data-toggle=\"tab\">Data</a></li><li><a href=\"#tab__list__input\" data-toggle=\"tab\">Input</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__list__data\" class=\"tab-pane fade in active\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__list__data__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__list__data__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__list__data__inputs\" aria-expanded=\"true\" aria-controls=\"content__list__data__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__list__data__create\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__list__data__src\"></select></div><div class=\"col-md-1\"><button id=\"content__list__data__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__list__data__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse in\"><br><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__data__inputs__title\" type=\"text\" placeholder=\"Title\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__data__inputs__tree\" type=\"text\" placeholder=\"Tree\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div style=\"padding-right: 0;\" class=\"col-md-8\"><input id=\"content__list__data__inputs__labels\" type=\"text\" placeholder=\"Labels\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding-left: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__status\" type=\"text\" placeholder=\"Status\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div style=\"padding-right: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date\" type=\"text\" placeholder=\"Date (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date_start\" type=\"text\" placeholder=\"Date Start (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding-left: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date_end\" type=\"text\" placeholder=\"Date Start (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div></div></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__list__data__holder\"><table id=\"content__list__data\" class=\"table table-bordered table-hover\"></table></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__list__data__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__data__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__list__data__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__data__export__type\"></select></div><div class=\"col-md-6\"></div></div></div><div id=\"tab__list__input\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__list__input__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__list__input__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__list__input__inputs\" aria-expanded=\"true\" aria-controls=\"content__list__input__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__list__input__create\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__list__input__src\"></select></div><div class=\"col-md-1\"><button id=\"content__list__input__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__list__input__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse in\"><br><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__filters__name\" type=\"text\" placeholder=\"Title\" style=\"width: 100%;\" class=\"form-control\"></div></div></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__list__input__holder\"><table id=\"content__list__input\" class=\"table table-bordered table-hover\"></table></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__list__input__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__input__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__list__input__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__input__export__type\"></select></div><div class=\"col-md-6\"></div></div></div></div></div></div></div><div id=\"tab__calendar\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><div id=\"tab__calendar\" class=\"tab-pane fade in\"><button id=\"content__calendar__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button><div id=\"content__calendar\"></div></div></div></div></div><div id=\"tab__report\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><button id=\"content__report__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button></div></div><br><div class=\"row\"><div class=\"col-sm-3\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__report__date\" data-toggle=\"tab\">X+1 by Date</a></li><li><a href=\"#tab__report__status\" data-toggle=\"tab\">X+1 by Status</a></li></ul></div><div class=\"col-sm-9\"><div class=\"tab-content\"><div id=\"tab__report__date\" class=\"tab-pane fade in active\"><div class=\"row\"><div style=\"padding-bottom: 20px\" class=\"col-md-12\"><h3>X+1 by Date</h3><input type=\"text\" placeholder=\"DD/MM/YYYY (Date)\" id=\"content__report__date__date\" class=\"form-control\"></div><div class=\"col-md-12\"><div style=\"height: 300px;\" class=\"table-responsive\"><div id=\"content__charts__date\"></div></div><div style=\"padding-top: 10px\" class=\"table-responsive\"><table id=\"content__report__date\" class=\"table-bordered table-condensed\"></table></div></div></div></div><div id=\"tab__report__status\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div style=\"padding-bottom: 20px\" class=\"col-md-12\"><h3>X+1 by Status</h3><input type=\"text\" placeholder=\"(Status)\" id=\"content__report__status__status\" class=\"form-control\"></div><div class=\"col-md-12\"><div style=\"height: 300px;\" class=\"table-responsive\"><div id=\"content__charts__status\"></div></div><div style=\"padding-top: 10px\" class=\"table-responsive\"><table id=\"content__report__status\" class=\"table-bordered table-condensed\"></table></div></div></div></div></div></div></div></div><div id=\"tab__option\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><button id=\"content__option__save\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-save\"></i></button></div></div><br><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__option__data\" data-toggle=\"tab\">Data</a></li><li class=\"undefined\"><a href=\"#tab__option__run\" data-toggle=\"tab\">Run</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__option__data\" class=\"tab-pane fade in active\"><table class=\"table table-bordered\"><tbody><tr><th style=\"width: 10px;\"></th><th>Data</th><th>DB / URL</th><th>Table</th></tr><tr><td><input id=\"content__option__data__static\" name=\"content__option__data\" type=\"radio\" value=\"static\" checked class=\"content__icheck\"></td><td colspan=\"3\">Static</td></tr><tr><td><input id=\"content__option__data__dexie\" name=\"content__option__data\" type=\"radio\" value=\"dexie\" class=\"content__icheck\"></td><td>Browser (IndexedDB: Dexie.js)</td><td>x_1</td><td>data</td></tr><tr><td><input id=\"content__option__data__lowdb\" name=\"content__option__data\" type=\"radio\" value=\"lowdb\" class=\"content__icheck\"></td><td>Browser (LocalStorage: LowDB)</td><td>x_1</td><td>data</td></tr><tr><td><input id=\"content__option__data__ajax\" name=\"content__option__data\" type=\"radio\" value=\"ajax\" class=\"content__icheck\"></td><td>Server (AJAX)</td><td colspan=\"2\"><input id=\"content__option__data__ajax__url\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__data__scriptform\" name=\"content__option__data\" type=\"radio\" value=\"scriptform\" class=\"content__icheck\"></td><td>Server (Script + Form)</td><td colspan=\"2\"><input id=\"content__option__data__scriptform__url\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__data__firebase\" name=\"content__option__data\" type=\"radio\" value=\"firebase\" class=\"content__icheck\"></td><td>Cloud (Firebase)</td><td colspan=\"2\"><input id=\"content__option__data__firebase__url\" class=\"form-control\"></td></tr></tbody></table></div><div id=\"tab__option__run\" class=\"tab-pane fade in\"><table class=\"table table-bordered\"><tbody><tr><th style=\"width: 10px;\">Status</th><th>Vendor</th><th>URL</th></tr><tr><td><input id=\"content__option__run__babel\" type=\"checkbox\" class=\"content__icheck\"></td><td>Babel</td><td><input id=\"content__option__run__babel__src\" value=\"../../vendors/transpiler/babel/babeljs.io-2016-03-01/babel.js\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__run__ts\" type=\"checkbox\" class=\"content__icheck\"></td><td>TypeScript</td><td><input id=\"content__option__run__ts__src\" value=\"../../vendors/transpiler/typescript/typescript-1.8.0/typescript.min.js\" class=\"form-control\"></td></tr></tbody></table></div></div></div></div></div></div></div></div></div><br><br><br><br><br><br><br></section>";

/***/ },
/* 37 */
/***/ function(module, exports) {

	module.exports = "         <section class=\"content-header\"><h1>&nbsp<i class=\"fa fa-codepen\"></i>&nbspX+1<small>0.16.0-input</small></h1><ol class=\"breadcrumb\"><li><a href=\"#/\" id=\"undefined\"><i class=\"fa fa-codepen\"></i>X+1</a></li><li><a href=\"#/\" id=\"header__data\"><i class=\"fa fa-database\"></i>Static</a></li></ol></section><section class=\"content\"><div class=\"row\"><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__run\" class=\"btn btn-primary\"><i class=\"fa fa-play\"></i></button>&nbsp&nbsp<input id=\"content__cmd__run__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutorun</div><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__save\" class=\"btn btn-success\"><i class=\"fa fa-save\"></i></button>&nbsp&nbsp<input id=\"content__cmd__save__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutosave</div><div class=\"col-xs-4 col-sm-2 col-md-2\"><button id=\"content__cmd__load\" class=\"btn btn-warning\"><i class=\"fa fa-repeat\"></i></button>&nbsp&nbsp<input id=\"content__cmd__load__auto\" type=\"checkbox\" class=\"content__icheck\">&nbsp&nbspAutoload</div><div class=\"col-xs-8 col-sm-3 col-md-4\"></div><div class=\"col-xs-4 col-sm-3 col-md-2\"><select id=\"content__layout__select\"></select></div></div><br><div id=\"content__layout\" class=\"row\"><div class=\"col-sm-12\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__input\" data-toggle=\"tab\">Input</a></li><li><a href=\"#tab__others\" data-toggle=\"tab\">Output + Others</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__input\" class=\"tab-pane active\"><div class=\"nav-tabs-custom\"><ul class=\"nav nav-tabs\"><li class=\"active\"><a href=\"#tab__input__notes\" data-toggle=\"tab\"><i class=\"fa fa-file-text\"></i>&nbsp&nbsp Notes</a></li></ul><div class=\"tab-content\"><div id=\"tab__input__notes\" class=\"tab-pane fade in active\"><div style=\"margin-bottom: 5px;\" class=\"row\"><div class=\"col-md-1\"><button id=\"content__input__notes__run\" type=\"button\" class=\"btn btn-default\"><i class=\"fa fa-play\"></i></button></div><div class=\"col-md-8\"><select id=\"content__input__notes__file\"></select></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__input__notes__ext\"></select></div><div class=\"col-md-1\"><button id=\"content__input__notes__file__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div class=\"row\"><div class=\"col-md-12\"><textarea id=\"content__input__notes__editor\"></textarea></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button type=\"button\" id=\"content__input__notes__export__button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__input__notes__export\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input type=\"file\" id=\"content__input__notes__import__button\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__input__notes__import\"></select></div><div style=\"/*padding: 0;*/\" class=\"col-md-2\"><input type=\"checkbox\" id=\"content__input__notes__lint\" class=\"content__icheck\">&nbsp&nbspLint</div><div class=\"col-md-4\"><select id=\"content__input__notes__mode\"></select></div></div></div></div></div></div><div id=\"tab__others\" class=\"tab-pane\"><div class=\"nav-tabs-custom\"><ul class=\"nav nav-tabs\"><li class=\"active\"><a href=\"#tab__output\" data-toggle=\"tab\"><i class=\"fa fa-desktop\"></i>&nbsp&nbsp Output</a></li><li><a href=\"#tab__tree\" data-toggle=\"tab\"><i class=\"fa fa-sitemap\"></i>&nbsp&nbsp Tree</a></li><li><a href=\"#tab__list\" data-toggle=\"tab\"><i class=\"fa fa-list\"></i>&nbsp&nbsp List</a></li><li><a href=\"#tab__calendar\" data-toggle=\"tab\"><i class=\"fa fa-calendar\"></i>&nbsp&nbsp Calendar</a></li><li><a href=\"#tab__report\" data-toggle=\"tab\"><i class=\"fa fa-bar-chart\"></i>&nbsp&nbsp Reports</a></li><li><a href=\"#tab__option\" data-toggle=\"tab\"><i class=\"fa fa-list-alt\"></i>&nbsp&nbsp Options</a></li></ul><div class=\"tab-content\"><div id=\"tab__output\" class=\"tab-pane fade in active\"><div style=\"margin-bottom: 5px;\" class=\"row\"><div id=\"content__output__index__button__holder\" class=\"col-md-1\"><button type=\"button\" id=\"content__output__index__urlhash__button\" class=\"btn btn-default\"><i class=\"fa fa-hashtag\"></i></button></div><div id=\"content__output__index__select__holder\" class=\"col-md-7\"><select id=\"content__output__index__urlhash\"></select></div><div style=\"padding-left: 0;\" class=\"col-md-2\"><select id=\"content__output__index__ext\"></select></div><div style=\"padding-left: 0;\" class=\"col-md-2\"><select id=\"content__run\"></select></div></div><div class=\"row\"><div class=\"col-md-12\"><div id=\"content__output__index__holder\"><iframe id=\"content__output__index__frame\"></iframe></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button type=\"button\" id=\"content__output__index__export__button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__output__index__export\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input type=\"file\" id=\"content__output__index__import__button\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__output__index__import\"></select></div><div style=\"/*padding: 0;*/\" class=\"col-md-2\"><input type=\"checkbox\" id=\"content__output__index__lint\" class=\"content__icheck\">&nbsp&nbspLint</div><div class=\"col-md-4\"><select id=\"content__output__index__mode\"></select></div></div></div><div id=\"tab__tree\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__tree__data\" data-toggle=\"tab\">Data</a></li><li><a href=\"#tab__tree__input\" data-toggle=\"tab\">Input</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__tree__data\" class=\"tab-pane fade in active\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__tree__data__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__tree__data__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__tree__data__inputs\" aria-expanded=\"false\" aria-controls=\"content__tree__data__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__tree__data__create\" type=\"button\" disabled class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__tree__data__src\"></select></div><div class=\"col-md-1\"><button id=\"content__tree__data__destroy\" type=\"button\" disabled class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__tree__data__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse\"><br></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__tree__data__holder\"><div id=\"content__tree__data\"></div></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__tree__data__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__data__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__tree__data__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__data__export__type\"></select></div><div class=\"col-md-6\"></div></div></div><div id=\"tab__tree__input\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__tree__input__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__tree__input__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__tree__input__inputs\" aria-expanded=\"false\" aria-controls=\"content__tree__input__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__tree__input__create\" type=\"button\" disabled class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__tree__input__src\"></select></div><div class=\"col-md-1\"><button id=\"content__tree__input__destroy\" type=\"button\" disabled class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__tree__input__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse\"><br></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__tree__input__holder\"><div id=\"content__tree__input\"></div></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__tree__input__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__input__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__tree__input__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__tree__input__export__type\"></select></div><div class=\"col-md-6\"></div></div></div></div></div></div></div><div id=\"tab__list\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__list__data\" data-toggle=\"tab\">Data</a></li><li><a href=\"#tab__list__input\" data-toggle=\"tab\">Input</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__list__data\" class=\"tab-pane fade in active\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__list__data__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__list__data__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__list__data__inputs\" aria-expanded=\"true\" aria-controls=\"content__list__data__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__list__data__create\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__list__data__src\"></select></div><div class=\"col-md-1\"><button id=\"content__list__data__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__list__data__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse in\"><br><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__data__inputs__title\" type=\"text\" placeholder=\"Title\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__data__inputs__tree\" type=\"text\" placeholder=\"Tree\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div style=\"padding-right: 0;\" class=\"col-md-8\"><input id=\"content__list__data__inputs__labels\" type=\"text\" placeholder=\"Labels\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding-left: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__status\" type=\"text\" placeholder=\"Status\" style=\"width: 100%;\" class=\"form-control\"></div></div><div class=\"row\"><div style=\"padding-right: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date\" type=\"text\" placeholder=\"Date (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date_start\" type=\"text\" placeholder=\"Date Start (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div style=\"padding-left: 0;\" class=\"col-md-4\"><input id=\"content__list__data__inputs__date_end\" type=\"text\" placeholder=\"Date Start (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div></div></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__list__data__holder\"><table id=\"content__list__data\" class=\"table table-bordered table-hover\"></table></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__list__data__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__data__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__list__data__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__data__export__type\"></select></div><div class=\"col-md-6\"></div></div></div><div id=\"tab__list__input\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div class=\"col-md-9\"><button id=\"content__list__input__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>&nbsp&nbsp<button id=\"content__list__input__inputs__toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\"#content__list__input__inputs\" aria-expanded=\"true\" aria-controls=\"content__list__input__inputs\" class=\"btn btn-default\"><i class=\"fa fa-search\"></i></button>&nbsp&nbsp<button id=\"content__list__input__create\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-plus\"></i></button></div><div style=\"padding-left: 0\" class=\"col-md-2\"><select id=\"content__list__input__src\"></select></div><div class=\"col-md-1\"><button id=\"content__list__input__destroy\" type=\"button\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-trash\"></i></button></div></div><div style=\"margin-left: 0; margin-right: 0\" class=\"row table-responsive\"><div id=\"content__list__input__inputs\" style=\"padding: 0;\" class=\"col-md-12 collapse in\"><br><div class=\"row\"><div class=\"col-md-12\"><input id=\"content__list__filters__name\" type=\"text\" placeholder=\"Title\" style=\"width: 100%;\" class=\"form-control\"></div></div></div><div style=\"padding: 10px 0 0 0;\" class=\"col-md-12\"><div id=\"content__list__input__holder\"><table id=\"content__list__input\" class=\"table table-bordered table-hover\"></table></div></div></div><br><div class=\"row\"><div class=\"col-md-1\"><button id=\"content__list__input__export\" type=\"button\" class=\"btn\"><i class=\"fa fa-download\"></i></button>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__input__export__type\"></select></div><div class=\"col-md-1\"><span class=\"btn btn-default btn-file\"><i class=\"fa fa-upload\"></i><input id=\"content__list__input__import\" type=\"file\"></span>&nbsp&nbsp</div><div class=\"col-md-2\"><select id=\"content__list__input__export__type\"></select></div><div class=\"col-md-6\"></div></div></div></div></div></div></div><div id=\"tab__calendar\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><div id=\"tab__calendar\" class=\"tab-pane fade in\"><button id=\"content__calendar__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button><div id=\"content__calendar\"></div></div></div></div></div><div id=\"tab__report\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><button id=\"content__report__refresh\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button></div></div><br><div class=\"row\"><div class=\"col-sm-3\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__report__date\" data-toggle=\"tab\">X+1 by Date</a></li><li><a href=\"#tab__report__status\" data-toggle=\"tab\">X+1 by Status</a></li></ul></div><div class=\"col-sm-9\"><div class=\"tab-content\"><div id=\"tab__report__date\" class=\"tab-pane fade in active\"><div class=\"row\"><div style=\"padding-bottom: 20px\" class=\"col-md-12\"><h3>X+1 by Date</h3><input type=\"text\" placeholder=\"DD/MM/YYYY (Date)\" id=\"content__report__date__date\" class=\"form-control\"></div><div class=\"col-md-12\"><div style=\"height: 300px;\" class=\"table-responsive\"><div id=\"content__charts__date\"></div></div><div style=\"padding-top: 10px\" class=\"table-responsive\"><table id=\"content__report__date\" class=\"table-bordered table-condensed\"></table></div></div></div></div><div id=\"tab__report__status\" class=\"tab-pane fade in undefined\"><div class=\"row\"><div style=\"padding-bottom: 20px\" class=\"col-md-12\"><h3>X+1 by Status</h3><input type=\"text\" placeholder=\"(Status)\" id=\"content__report__status__status\" class=\"form-control\"></div><div class=\"col-md-12\"><div style=\"height: 300px;\" class=\"table-responsive\"><div id=\"content__charts__status\"></div></div><div style=\"padding-top: 10px\" class=\"table-responsive\"><table id=\"content__report__status\" class=\"table-bordered table-condensed\"></table></div></div></div></div></div></div></div></div><div id=\"tab__option\" class=\"tab-pane fade in\"><div class=\"row\"><div class=\"col-md-12\"><button id=\"content__option__save\" type=\"button\" class=\"btn btn-success\"><i class=\"fa fa-save\"></i></button></div></div><br><div class=\"row\"><div class=\"col-sm-2\"><ul class=\"nav nav-tabs tabs-left\"><li class=\"active\"><a href=\"#tab__option__data\" data-toggle=\"tab\">Data</a></li><li class=\"undefined\"><a href=\"#tab__option__run\" data-toggle=\"tab\">Run</a></li></ul></div><div class=\"col-sm-10\"><div class=\"tab-content\"><div id=\"tab__option__data\" class=\"tab-pane fade in active\"><table class=\"table table-bordered\"><tbody><tr><th style=\"width: 10px;\"></th><th>Data</th><th>DB / URL</th><th>Table</th></tr><tr><td><input id=\"content__option__data__static\" name=\"content__option__data\" type=\"radio\" value=\"static\" checked class=\"content__icheck\"></td><td colspan=\"3\">Static</td></tr><tr><td><input id=\"content__option__data__dexie\" name=\"content__option__data\" type=\"radio\" value=\"dexie\" class=\"content__icheck\"></td><td>Browser (IndexedDB: Dexie.js)</td><td>x_1</td><td>data</td></tr><tr><td><input id=\"content__option__data__lowdb\" name=\"content__option__data\" type=\"radio\" value=\"lowdb\" class=\"content__icheck\"></td><td>Browser (LocalStorage: LowDB)</td><td>x_1</td><td>data</td></tr><tr><td><input id=\"content__option__data__ajax\" name=\"content__option__data\" type=\"radio\" value=\"ajax\" class=\"content__icheck\"></td><td>Server (AJAX)</td><td colspan=\"2\"><input id=\"content__option__data__ajax__url\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__data__scriptform\" name=\"content__option__data\" type=\"radio\" value=\"scriptform\" class=\"content__icheck\"></td><td>Server (Script + Form)</td><td colspan=\"2\"><input id=\"content__option__data__scriptform__url\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__data__firebase\" name=\"content__option__data\" type=\"radio\" value=\"firebase\" class=\"content__icheck\"></td><td>Cloud (Firebase)</td><td colspan=\"2\"><input id=\"content__option__data__firebase__url\" class=\"form-control\"></td></tr></tbody></table></div><div id=\"tab__option__run\" class=\"tab-pane fade in\"><table class=\"table table-bordered\"><tbody><tr><th style=\"width: 10px;\">Status</th><th>Vendor</th><th>URL</th></tr><tr><td><input id=\"content__option__run__babel\" type=\"checkbox\" class=\"content__icheck\"></td><td>Babel</td><td><input id=\"content__option__run__babel__src\" value=\"../../vendors/transpiler/babel/babeljs.io-2016-03-01/babel.js\" class=\"form-control\"></td></tr><tr><td><input id=\"content__option__run__ts\" type=\"checkbox\" class=\"content__icheck\"></td><td>TypeScript</td><td><input id=\"content__option__run__ts__src\" value=\"../../vendors/transpiler/typescript/typescript-1.8.0/typescript.min.js\" class=\"form-control\"></td></tr></tbody></table></div></div></div></div></div></div></div></div></div></div></div></div><br><br><br><br><br><br><br></section>";

/***/ },
/* 38 */
/***/ function(module, exports) {

	module.exports = "{\n  \"index\": {\"src\": \"Hi\",  \"name\":\"index\", \"ext\":\"md\", \"mode\":\"text/x-markdown\"},\n  \"next\":  {\"src\": \"777\", \"name\":\"next\",  \"ext\":\"md\", \"mode\":\"text/x-markdown\"}\n}";
