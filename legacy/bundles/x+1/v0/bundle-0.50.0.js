	...
	Store.prototype = {
	  ...
	  create: function(attrs, cb){
	    ...
	    id = this.db.child(this.table).push(attrs, function(e){
	      attrs.id = id.key();
	      _this.db.child(_this.table).child(attrs.id).update(attrs);
	      cb(attrs);
	    });
	  },
