...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.extIsValidJs = function(o){
	    ...
	    valid = true;
	    exts = ['html', 'js', 'css', 'md', '++.md', 'jade', 'less', 'sass', 'styl', 'ls', 'jsx', 'babel.js', 'ts', 'cs', 'json', 'yaml', 'xml', 'sql', 'mongo.js', 'abc'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runGetExtsRegistered = function(o){
	    return this.runGetConfigJs(o);
	  };
	  ...
	  o.runFrontJs = function(o){
	    var _this, output, input, exts, isExtsLoaded, cb;
	    if (this.debug) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runTranspilerTsJs = function(o){
	    var _this, types;
	    if (this.debug) {
	      console.log('Run:Transpiler:Ts');
	    }
	    _this = this;
	    types = {
	      frame: function(){
	        _this.runTranspilerTsFrame(o);
	      },
	      editor: function(){
	        _this.runTranspilerTsEditor(o);
	      },
	      compile: function(){
	        return _this.runTranspilerTsCompile(o);
	      }
	    };
	    return types[o.type]();
	  };
	  o.runTranspilerTsFrameJs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Ts:Frame');
	    }
	    o.script = this.runTranspilerTsCompile(o);
	    o.src = false;
	    this.runDisplay(o);
	  };
	  o.runTranspilerTsEditorJs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Ts:Editor');
	    }
	    o.src = this.runTranspilerTsCompile(o);
	    this.runDisplay(o);
	  };
	  o.runTranspilerTsCompileTs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Ts:Compile');
	    }
