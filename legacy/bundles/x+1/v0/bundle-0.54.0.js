...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  options: {
	    ...
	    run_style_less: {
	      id: 'content__option__run__style-babel',
	      title: 'LESS'
	    },
	    run_style_sass: {
	      id: 'content__option__run__style-sass',
	      title: 'SASS'
	    },
	    run_style_stylus: {
	      id: 'content__option__run__style-stylus',
	      title: 'Stylus'
	    },
	    run_transpiler_babel: {
	      id: 'content__option__run__transpiler-babel',
	      title: 'Babel'
	    },
	    run_transpiler_ts: {
	      id: 'content__option__run__transpiler-ts',
	      title: 'TypeScript'
	    },
	    run_transpiler_cs: {
	      id: 'content__option__run__transpiler-cs',
	      title: 'CoffeeScript'
	    }
	  }
	};
	...
	Store.prototype = {
	  ...
	  importTable: function(table, cb){
	    ...
	    this.db.transaction('rw', this.table, function(){
	      return _this.db[_this.table].clear();
	    }).then(function(){
	      var i$, ref$, len$, i, el;
	      for (i$ = 0, len$ = (ref$ = table).length; i$ < len$; ++i$) {
	        i = i$;
	        el = ref$[i$];
	        _this.db[_this.table].put(el);
	      }
	    }).then(function(){
	      cb();
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	Store.prototype = {
	  ...
	  update: function(id, attrs, cb){
	    var idInt;
	    idInt = parseInt(id);
	    $.post(this.db + '/update', attrs, function(item){
	      if (cb) {
	        cb(JSON.parse(item));
	      }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initLintJqIc = function(){
	    ...
	    $('#content__input__notes__lint').on('ifChanged', function(){
	      var checked;
	      checked = $('#content__input__notes__lint').prop('checked');
	      _this.editorToggleLint({
	        context: 'inputs',
	        entity: 'notes',
	        state: checked
	      });
	  ...
	  o.lintGetValueIc = function(o){
	    ...
	    value = $('#content__' + ids[o.context] + '__' + o.entity + '__lint').prop('checked');
	    return value;
	  };
	};
	if (true) {
	...
	Component = function(Component){
	  ...
	  o.initRunDefaultsJs = function(o){
	    ...
	    this.runs = {
	      ...
	      'less': function(o){
	        return _this.runTemplateLess(o);
	      },
	      'sass': function(o){
	        return _this.runTemplateSass(o);
	      },
	      'styl': function(o){
	        return _this.runTemplateStyl(o);
	      },
	      'ls': function(o){
	      ...
	      'cs': function(o){
	        return _this.runTranspilerCs(o);
	      },
	      'json': function(o){
	        return _this.runTranspilerJson(o);
	      },
	      'yaml': function(o){
	        return _this.runTranspilerYaml(o);
	      },
	      'xml': function(o){
	        return _this.runTranspilerXml(o);
	      },
	      'sql': function(o){
	        return _this.runTranspilerSql(o);
	      },
	      'mongo.js': function(o){
	        return _this.runTranspilerMongo(o);
	      },
	      'php': function(o){
	        return _this.runTranspilerPhp(o);
	      },
	      'ruby': function(o){
	        return _this.runTranspilerRuby(o);
	      },
	      'python': function(o){
	        return _this.runTranspilerPython(o);
	      },
	      'abc': function(o){
	        return _this.runTranspilerAbc(o);
	      },
	      'ashx': function(o){},
	      'java': function(o){},
	      'go': function(o){},
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0\component\jquery\component\main\run\style\less.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0\component\jquery\component\main\run\style\sass.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\x+1\v0\component\jquery\component\main\run\style\stylus.ls.map
