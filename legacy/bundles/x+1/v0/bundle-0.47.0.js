...
/***/ function(module, exports, __webpack_require__) {
	...
	templates = {
	  ...
	  admin: {
	    inputs: {
	      list_data: __webpack_require__(10)
	    }
	  },
	  app: {
	    work_time: __webpack_require__(11),
	    work_job: __webpack_require__(12)
	  }
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputFindAllExts = function(o){
	    return this.inputFindAllExtsJs(o);
	  };
	  ...
	  o.inputFindAllExtsJs = function(o){
	    var inputs;
	    if (this.debug) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.outputBundleMarkup = function(o){
	    return this.outputBundleMarkupDmDpXz(o);
	  };
	  ...
	  o.outputRunFrameJs = function(o){
	    ...
	    if (o.src) {
	      content = this.outputBundleMarkup({
	        content: content,
	        pattern: 'div[data-include]'
	      });
	      content = this.outputBundleMarkup({
	        content: content,
	        pattern: 'style[data-include], script[data-include]'
	      });
	    }
	    if (o['export']) {
	      o['export']({
	  ...
	  o.outputBundleMarkupDmDpXz = function(o){
	    ...
	    return content;
	    function fn$(i, el){
	      var html, name, stringify, bundle;
	      html = '';
	      name = el.attributes['data-include'].nodeValue;
	      stringify = '';
	      if (el.attributes['data-stringify']) {
	        stringify = el.attributes['data-stringify'].nodeValue;
	      }
	      bundle = this.run({
	        file: name,
	        type: 'compile'
	      ...
	      if (stringify) {
	        html = stringify + '["' + name + '"] = ' + JSON.stringify(bundle) + ';';
	      } else {
	        html = bundle;
	      }
	      el.innerHTML = html;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runMarkdownMarkedFrame = function(o){
	    this.runMarkdownMarkedFrameJs(o);
	  };
	  o.runMarkdownMarkedEditor = function(o){
	    this.runMarkdownMarkedEditorJs(o);
	  };
	  o.runMarkdownMarkedCompile = function(o){
	    return this.runMarkdownMarkedCompileJs(o);
	  };
	  ...
	  o.runMarkdownMarkedFrameJs = function(o){
	    if (this.debug) {
	      console.log('Run:Markdown:Marked:Frame');
	    }
	    o.src = this.runMarkdownMarkedCompile(o);
	    this.runDisplay(o);
	  };
	  o.runMarkdownMarkedEditorJs = function(o){
	    if (this.debug) {
	  ...
	  o.runMarkdownMarkedCompileJs = function(o){
	    var data_stringify, src;
	    if (this.debug) {
	      console.log('Run:Markdown:Marked:Compile');
	    }
	    data_stringify = false;
	    if (o.global['ext'] && o.global['ext']['md']) {
	      if (o.global['ext']['md']['data-stringify']) {
	        data_stringify = true;
	      }
	    }
	    src = marked(o.src);
	    if (data_stringify) {
	      src = 'window.data[\'' + o.name + '\'] = ' + JSON.stringify(src + ';');
	    }
	    return src;
	  };
	};
