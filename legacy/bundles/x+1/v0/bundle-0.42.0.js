...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.valueMakeContainer = function(o){
	    return this.valueMakeContainerSz(o);
	  };
	  o.valueMakeRefreshable = function(o){
	    this.valueMakeRefreshableJq(o);
	  };
	  o.valueMakeDestroyable = function(o){
	    this.valueMakeDestroyableJq(o);
	  };
	  o.valueMakeCreatable = function(o){
	    this.valueMakeCreatableJq(o);
	  };
	  o.valueOnChange = function(o){
	    this.valueOnChangeJs(o);
	  };
	  o.valueOnCreate = function(o){
	    return this.valueOnCreateJs(o);
	  };
	  o.valueReset = function(o){
	    this.valueResetSzJq(o);
	  };
	  o.valueRefresh = function(o){
	    this.valueRefreshSz(o);
	  };
	  o.valueCreate = function(o){
	    this.valueCreateSz(o);
	  };
	  o.valueDestroy = function(o){
	    this.valueDestroySz(o);
	  };
	  o.valueSetValue = function(o){
	    this.valueSetValueSz(o);
	  };
	  o.valueGetValue = function(o){
	    return this.valueGetValueSz(o);
	  };
	  o.valueSetHeaders = function(o){
	    this.valueSetHeadersJq(o);
	  };
	  o.valueRenderValue = function(o){
	    return this.valueRenderValueJs(o);
	  };
	  o.valueRenderOption = function(o){
	    return this.valueRenderOptionJs(o);
	  };
	  o.initValueJs = function(){
	    if (this.debug) {
	      console.log('Value!');
	    }
	    this.value = this.valueMakeContainer();
	    this.valueMakeRefreshable();
	    this.valueRefresh();
	  };
	  o.valueMakeContainerSz = function(o){
	    var _this, config;
	    if (this.debug) {
	      console.log('Value:Make:Container');
	    }
	    _this = this;
	    config = function(){
	      return {
	        ...
	        create: function(value){
	          return _this.valueOnCreate({
	            value: value
	          });
	        },
	        render: {
	          item: function(item, escape){
	            return _this.valueRenderValue({
	              item: item
	            });
	          },
	          option: function(item, escape){
	            return _this.valueRenderOption({
	              item: item
	            });
	          }
	        }
	  ...
	  o.valueMakeRefreshableJq = function(o){
	    var _this;
	    if (this.debug) {
	      console.log('Value:Make:Refreshable');
	    }
	    _this = this;
	  ...
	  o.valueMakeDestroyableJq = function(o){
	    var _this;
	    if (this.debug) {
	      console.log('Value:Make:Destroyable');
	    }
	    _this = this;
	    $('#content__value__destroy').click(function(){
	      var value;
	      value = _this.valueGetValue();
	      _this.valueDestroy({
	        value: value
	      });
	    });
	  };
	  o.valueOnChangeJs = function(o){
	    if (this.debug) {
	  ...
	  o.valueOnCreateJs = function(o){
	    if (this.debug) {
	      console.log('Value:On:Create');
	    }
	    return null;
	  };
	  o.valueResetSzJq = function(o){
	    if (this.debug) {
	  ...
	  o.valueCreateSz = function(o){
	    if (this.debug) {
	      console.log('Value:Create');
	    }
	    this.value.addOption(o.option);
	  };
	  o.valueDestroySz = function(o){
	    if (this.debug) {
	      console.log('Value:Destroy');
	    }
	    this.value.removeOption(o.value);
	  };
	  o.valueSetValueSz = function(o){
	    if (this.debug) {
	      console.log('Value:Set:Value');
	    }
	    this.value.setValue(o.value, function(){});
	  };
	  o.valueGetValueSz = function(o){
	    if (this.debug) {
	      console.log('Value:Get:Value');
	    }
	    return this.value.getValue();
	  };
	  o.valueRenderValueJs = function(o){
	    if (this.debug) {
	      console.log('Work:Job:Value:Render:Value');
	    }
	    return '<div>' + '<span>' + (o.item.tree || '') + '</span> ' + '</div>';
	  };
	  o.valueRenderOptionJs = function(o){
	    if (this.debug) {
	      console.log('Work:Job:Value:Render:Option');
	    }
	    return '<div>' + '<span>' + (o.item.tree || '') + '</span> ' + '</div>';
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.appWorkJobValueMakeJs = function(o){
	    ...
	    this.app['export'] = function(){
	      _this['appWorkJobValue' + 'Export']();
	    };
	    this.app['import'] = function(){
	      _this['appWorkJobValue' + 'Import']();
	    };
	    for (i$ = 0, len$ = (ref$ = this.app.entity['work_job'].columns).length; i$ < len$; ++i$) {
	      (fn$.call(this, i$, ref$[i$]));
	    }
	    this.app.refresh();
	    function fn$(i, el){
	  ...
	  o.appWorkJobValueOnChangeJs = function(o){
	    ...
	    cb = function(attrs){
	      ...
	      for (i$ = 0, len$ = (ref$ = _this.app.entity['work_job'].columns).length; i$ < len$; ++i$) {
	        (fn$.call(this, i$, ref$[i$]));
	      }
	      function fn$(i, el){
