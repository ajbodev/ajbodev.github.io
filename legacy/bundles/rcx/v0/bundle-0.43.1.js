...
/***/ function(module, exports, __webpack_require__) {
	...
	Store = function(o){
	  ...
	  this.list = [];
	  try {
	    this.others = JSON.parse(o.others);
	  } catch (e$) {
	    e = e$;
	    console.log(e);
	  }
