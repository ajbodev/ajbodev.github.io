...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.frameMakeUrlhashListenableDm = function(o){
	    if (this.debug) {
	      console.log('Frame:Make:Urlhash:Listenable');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.scriptIsExtLoadedJs = function(o){
	    var scripts;
	    if (this.debug) {
	      console.log('Script:Is:Ext:Loaded');
	    }
	    scripts = {
	      'html': 7
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runFrontJs = function(o){
	    ...
	    console.log('A', exts, isExtsLoaded);
	    cb = function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.runTranspilerCoffeescriptJs = function(o){
	    var _this, types;
	    if (this.debug) {
	      console.log('Run:Transpiler:Coffeescript');
	    }
	    _this = this;
	    types = {
	      frame: function(){
	  ...
	  o.runTranspilerCoffeescriptFrameJs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Coffeescript:Frame');
	    }
	  ...
	  o.runTranspilerCoffeescriptEditorJs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Coffeescript:Editor');
	    }
	  ...
	  o.runTranspilerCoffeescriptCompileTs = function(o){
	    if (this.debug) {
	      console.log('Run:Transpiler:Coffeescript:Compile');
	    }
