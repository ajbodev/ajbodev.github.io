...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  select: {
	    ...
	    creatable: 'elementOnCreateModal',
...
/***/ function(module, exports, __webpack_require__) {
	...
	templates = {
	  ...
	  admin: {
	    tree_data: __webpack_require__(26),
	    list_data: __webpack_require__(27)
	  }
	};
	if (true) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"col-md-12\"><input id=\"content__tree__search__tree\"></div><div style=\"padding-top: 10px;\" class=\"col-md-12\"><div id=\"content__tree\"></div></div>";

/***/ },
/* 27 */
/***/ function(module, exports) {

	module.exports = "<div class=\"col-md-12\"><input id=\"content__list__name\" type=\"text\" placeholder=\"Name\" style=\"width: 100%;\" class=\"form-control\"></div><div class=\"col-md-12\"><input id=\"content__list__date\" type=\"text\" placeholder=\"Date (DD/MM/YYYY)\" style=\"width: 100%;\" class=\"form-control\"></div><div class=\"col-md-12\"><table id=\"content__list\"></table></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initElementJs = function(){
	    ...
	    $ '#content__admin' .html @templates.admin.tree_data
	    @treeDataMakeContainer @props.admin.tree.data
	    */
	    this.refresh = function(){
	      _this.listDataRefresh();
	    };
	    $('#content__admin').html(this.templates.admin.list_data);
	    this.listDataMakeContainer(this.props.admin.list.data);
	  };
