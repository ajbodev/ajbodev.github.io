...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.defaultMakeStoreJs = function(o){
	    ...
	    this.store = {};
	    this.setting = 'settings_rcx_self';
	    this.id = null;
	    this.name = null;
	    this.child = null;
	    this.data = {};
