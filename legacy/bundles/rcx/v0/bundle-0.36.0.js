...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementSetHeadersJq = function(o){
	    ...
	    save_button = id ? false : true;
	    $('#content__save').prop('disabled', save_button);
	  };
	};
	if (true) {
	  module.exports = Component;
