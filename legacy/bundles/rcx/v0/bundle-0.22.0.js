...
/***/ function(module, exports, __webpack_require__) {
	...
	props = {
	  ...
	  route: {
	    routes: {
	      '/id/:id': 'elementSetById',
	      '/name/?((w|.)*)': 'elementSetByName'
	    }
	  },
	  sample: {
	    id: 'content__sample',
...
/***/ function(module, exports, __webpack_require__) {
	...
	Stores = {
	  ...
	  indexeddb: __webpack_require__(16),
	  localstorage: __webpack_require__(18),
	  ajax: __webpack_require__(20),
	  firebase: __webpack_require__(21)
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	templates = {
	  layout: {
	    split: __webpack_require__(23),
	    split_vtab: __webpack_require__(24),
	    combined: __webpack_require__(25)
	  }
	};
	if (true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\rcx\v0\component\jquery\component\boot\option.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.inputCreateJs = function(o){
	    ...
	    sample = this.samples.html_css_js['input_' + o.entity]['index'];
	  ...
	  o.inputOnExtChangeJs = function(o){
	    ...
	    sample = this.samples.html_css_js[o.entity];
	    if (o.value !== '') {
	      this.inputUpdate({
	        entity: o.entity,
	        file: file,
	...
	Component = function(Component){
	  ...
	  o.initScriptJs = function(){
	    ...
	    this.loadeds = {
	      ...
	      'md': function(o){
	        return _this.runMarkdownMarkedIs();
	      },
	      'jade': function(o){
	        return _this.runTemplateJadeIs();
	      },
	      'less': function(o){
	        return _this.runPreprocessorLessIs();
	      },
	      'sass': function(o){
	        return _this.runPreprocessorSassIs();
	      },
	      'styl': function(o){
	        return _this.runPreprocessorStylusIs();
	      },
	      'babel.js': function(o){
	        return _this.runTranspilerBabelIs();
	      },
	      'ts': function(o){
	        return _this.runTranspilerTypescriptIs();
	      },
	      'cs': function(o){
	        return _this.runTranspilerCoffeescriptIs();
	      },
	      'ls': function(o){
	        return _this.runTranspilerLivescripIs();
	      }
	    };
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.includeMultiple = function(o){
	    return this.includeMultipleDmDpXzJn(o);
	  };
	  ...
	  o.includeMultipleDmDpXzJn = function(o){
	    var _this, dom, includes, i$, len$, content;
	    _this = this;
	    this.consoleLog({
	      text: 'Include:Multiple'
	    });
	    dom = new DOMParser().parseFromString(o.content, 'text/html');
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.routeOnName = function(o){
	    this.routeOnNameJs(o);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.selectRenderValueJs = function(o){
	    ...
	    return '<div>' + '<span>' + (o.item.id + '').substring(0, 4) + ' :</span> ' + '<span>' + (o.item.name || '') + '</span> ' + '</div>';
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.elementSetHeaders = function(o){
	    this.elementSetHeadersJq(o);
	  };
	  ...
	  o.elementSetHeadersJq = function(o){
	    var _this, id, name;
	    _this = this;
	    this.consoleLog({
	      text: 'Element:Find:All'
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.exportMakeDataJq = function(o){
	    ...
	    $('#content__data__export').click(function(){
	      var format, exporter;
	      format = 'json';
	      exporter = {
	        json: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.importMakeDataJqFr = function(o){
	    ...
	    $('#content__data__import').change(function(){
	      var format, importer, reader;
	      format = 'json';
	      importer = {
	        json: function(o){
