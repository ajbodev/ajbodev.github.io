...
/***/ function(module, exports, __webpack_require__) {
	...
	Component = function(Component){
	  ...
	  o.initValueJs = function(){
	    ...
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./value/data.ls\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(Component);
	    this.value = this.valueDataMakeContainer();
	    this.valueDataMakeRefreshable();
	    this.valueDataMakeDestroyable();
	    this.valueDataRefresh();
	  };
	};
	if (true) {
	  module.exports = Component;
	}
	//# sourceMappingURL=e:\app\node_modules\livescript-loader\index.js!e:\app\src\rcx\v0\component\jquery\component\admin\value.ls.map
