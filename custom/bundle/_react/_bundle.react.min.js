...
__script('https://cdnjs.cloudflare.com/ajax/libs/react/16.8.6/umd/react.production.min.js');
__script('https://cdnjs.cloudflare.com/ajax/libs/react-dom/16.8.6/umd/react-dom.production.min.js');
...
__script('https://cdnjs.cloudflare.com/ajax/libs/react-router-dom/5.0.1/react-router-dom.min.js');
__script('https://cdnjs.cloudflare.com/ajax/libs/react-redux/7.1.0/react-redux.min.js');
__script('https://cdnjs.cloudflare.com/ajax/libs/reselect/4.0.0/reselect.min.js');
__script('https://cdnjs.cloudflare.com/ajax/libs/recompose/0.26.0/Recompose.min.js');
__script('https://ajbodev.github.io/custom/vendor/jsxtransformer/0.13.3/jsxtransformer.min.js');
